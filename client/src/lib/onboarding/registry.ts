...
export const ONBOARDING_REGISTRY: Record<string, RouteOnboarding> = {
  ...
  "/evolucao": { type: "pendente" },
  "/simulador": REDIRECT("/"),
  "/ingles": { type: "pendente" },
  ...
  "/ferramentas": { type: "pendente" },
  "/ia": { type: "pendente" },
  "/mentorias": { type: "pendente" },
  "/admin": FLUXO("painel administrativo"),
  "/roadmaps": { type: "pendente" },
  ...
  "/faculdades": { type: "pendente" },
  "/eventos": { type: "pendente" },
  ...
  "/noticias": { type: "pendente" },
  "/comunidades": { type: "pendente" },
  "/sobre": { type: "pendente" },
  "/dicas": { type: "pendente" },
  "/mulheres": { type: "pendente" },
  "/dicionario": { type: "pendente" },
  "/comparador": { type: "pendente" },
  "/quiz-carreira/resultado": { type: "pendente" },
  "/quiz-carreira": { type: "pendente" },
