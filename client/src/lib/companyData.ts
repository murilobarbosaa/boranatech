...
const baseCompanies = [
  [
    ...
    "São Paulo",
    true,
    ["typescript", "python", "aws", "kubernetes"],
    "R$ 5.000 a R$ 8.000",
  ],
  [
    "iFood",
  ...
  ([name, segment, city, hiresJunior, technologies, juniorSalary], index) => ({
    ...
    openJobs: [
      ...(hiresJunior
        ...
        : []),
      ...(!hiresJunior && index % 2 === 0
        ? [
            {
              title: "Trainee em Produto e Tecnologia",
              area: "Carreira inicial",
              location: city,
              level: "Trainee",
            },
...
export const companyHiringLevels = [
  "Todas",
  "Estágio",
  "Trainee",
  "Júnior",
