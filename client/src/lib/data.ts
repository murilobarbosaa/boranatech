...
export const areasTI: AreaTI[] = [
  ...
  },
  {
    ...
    subareas: [
      ...
      },
      {
        ...
        faixaSalarial: "R$ 4.000 (júnior) a R$ 18.000 (sênior em fintechs/big techs). Média BR R$ 5.458-6.500. Especialistas em design systems ou IA design chegam a R$ 15k+. Vagas remotas pra fora pagam em dólar.",
        dificuldade: 4,
        cursosGratuitos: [
  ...
  },
  {
    ...
    icon: LineChart,
    tagClass: "tag-dados",
    descricaoCurta: "Transforma dados em relatórios, dashboards e insights para apoiar decisões de negócio.",
    descricaoCompleta: "O analista de dados (ou de BI) coleta, limpa e organiza dados de diferentes fontes para responder perguntas de negócio. Cria dashboards e relatórios que ajudam times e gestores a decidir com base em números, não em achismo. É uma das principais portas de entrada na área de dados: exige menos matemática avançada que ciência de dados, mas muito SQL, visualização e capacidade de contar histórias com os dados.",
    oQueFaz: "Extrai dados com SQL, organiza, cria dashboards e relatórios e traduz números em recomendações para o negócio.",
    tarefasDiarias: ["Escrever consultas SQL para extrair dados de bancos", "Limpar e organizar planilhas e tabelas", "Criar dashboards no Power BI, Looker Studio ou Tableau", "Traduzir perguntas de negócio em métricas e indicadores", "Apresentar resultados e insights para times e gestores"],
    perfilIndicado: "Combina com quem gosta de números, tem curiosidade por entender o porquê das coisas e sabe se comunicar bem. Não precisa de matemática pesada, mas precisa de organização e atenção ao detalhe.",
    habilidades: ["SQL (consultas, joins e agregações)", "Excel ou Planilhas avançado", "Power BI, Looker Studio ou Tableau", "Estatística descritiva básica", "Storytelling com dados", "Inglês para leitura"],
    ferramentas: ["SQL", "Power BI", "Looker Studio", "Tableau", "Excel / Google Sheets", "Python (pandas) básico"],
    dificuldade: 3,
    cargos: ["Analista de Dados Júnior", "Analista de BI", "Analista de Dados Pleno", "Analista de Dados Sênior"],
    faixaSalarial: "Júnior R$ 3.000 a R$ 5.000, Pleno R$ 5.500 a R$ 8.300, Sênior R$ 9.000 a R$ 13.000 (Glassdoor 2026)",
    cursosGratuitos: ["Microsoft Learn: trilha de Power BI (gratuita)", "Curso em Vídeo: MySQL (Gustavo Guanabara)", "Kaggle Learn: Pandas e Data Visualization (gratuito, em inglês)", "DIO: bootcamps gratuitos de Análise de Dados"],
    roadmapInicial: ["Aprender SQL do básico ao intermediário", "Dominar Excel ou Google Sheets", "Aprender uma ferramenta de BI (Power BI é a mais pedida)", "Estudar estatística descritiva básica", "Construir 2 ou 3 dashboards com dados públicos", "Publicar os projetos no GitHub ou portfólio"],
    projetos: ["Dashboard de vendas com dados públicos", "Análise de uma base do governo (dados.gov.br)", "Relatório de métricas de um e-commerce fictício"],
    termosEssenciais: ["SQL", "Dashboard", "KPI", "ETL", "Data Viz", "Query"],
    dicasIniciais: "Foque em SQL e em uma ferramenta de BI antes de qualquer coisa. Use datasets reais e sempre explique o insight, não só mostre o gráfico. Saber contar a história por trás dos números vale mais que dominar dez ferramentas.",
    requiresGraduation: "opcional",
    tempoMedioFormacao: "6 a 12 meses até a primeira vaga",
    crescimentoMercado: "alto",
    faculdadesRelacionadas: ["Análise e Desenvolvimento de Sistemas (ADS)", "Ciência de Dados", "Estatística", "Sistemas de Informação"]
  },
  {
    id: "engenharia-dados",
    ...
    icon: Boxes,
    tagClass: "tag-dados",
    descricaoCurta: "Constrói e mantém a infraestrutura e os pipelines que levam dados até quem analisa.",
    ...
    oQueFaz: "Constrói pipelines de dados (ETL e ELT), modela data warehouses e garante que os dados cheguem limpos e disponíveis para análise.",
    tarefasDiarias: ["Construir e manter pipelines de dados (ETL e ELT)", "Modelar tabelas e data warehouses", "Trabalhar com bancos SQL e ferramentas como dbt e Spark", "Automatizar e monitorar a ingestão de dados", "Garantir qualidade, governança e disponibilidade dos dados"],
    perfilIndicado: "Combina com quem gosta da parte de engenharia e de programação, tem paciência para resolver problemas de dados sujos e se importa com confiabilidade e organização. Mais código e infraestrutura, menos gráficos.",
    habilidades: ["SQL avançado", "Python", "Modelagem de dados e data warehouse", "Pipelines ETL e ELT (Airflow, dbt)", "Cloud (AWS, GCP ou Azure)", "Spark e processamento distribuído"],
    ferramentas: ["Python", "SQL", "Apache Airflow", "dbt", "Apache Spark", "BigQuery / Snowflake", "Docker", "AWS / GCP"],
    dificuldade: 4,
    cargos: ["Engenheiro de Dados Júnior", "Engenheiro de Dados Pleno", "Engenheiro de Dados Sênior", "Arquiteto de Dados"],
    faixaSalarial: "Júnior R$ 5.000 a R$ 8.500, Pleno R$ 9.000 a R$ 15.000, Sênior acima de R$ 20.000 (Glassdoor 2026)",
    cursosGratuitos: ["Data Engineering Zoomcamp (DataTalks.Club, gratuito, coorte de janeiro)", "Databricks Customer Academy: cursos gratuitos em português", "Data Science Academy: Fundamentos de Engenharia de Dados (gratuito, com certificado)", "Curso em Vídeo: Python (base de programação)"],
    roadmapInicial: ["Aprender Python e SQL com solidez", "Entender modelagem de dados e data warehouse", "Aprender a construir pipelines (ETL e ELT)", "Estudar uma cloud (BigQuery é um bom começo)", "Aprender Docker e orquestração com Airflow", "Construir um pipeline completo de ponta a ponta"],
    projetos: ["Pipeline que coleta dados de uma API e salva num banco", "ETL de arquivos CSV para um data warehouse", "Pipeline agendado com Airflow e dbt"],
    termosEssenciais: ["Pipeline", "ETL", "Data Warehouse", "Data Lake", "Orquestração", "Batch e Streaming"],
    dicasIniciais: "Engenharia de dados não costuma ser a primeira porta de entrada: vale ter base de programação (Python) e SQL antes. Domine um banco de dados e aprenda a versionar e automatizar tudo. O Zoomcamp gratuito é um dos melhores caminhos práticos.",
    requiresGraduation: "opcional",
    tempoMedioFormacao: "12 a 24 meses (costuma exigir base anterior)",
    crescimentoMercado: "alto",
    faculdadesRelacionadas: ["Análise e Desenvolvimento de Sistemas (ADS)", "Ciência da Computação", "Engenharia de Software", "Ciência de Dados"]
  },
  {
    id: "banco-de-dados",
    ...
    icon: Database,
    tagClass: "tag-dados",
    descricaoCurta: "Cuida do armazenamento, performance, segurança e integridade dos bancos de dados.",
    descricaoCompleta: "O administrador de banco de dados (DBA) é responsável por manter os bancos de dados de uma empresa funcionando bem: rápidos, seguros, disponíveis e sem perda de dados. Ajusta consultas lentas, faz backups, controla acessos e planeja a estrutura dos dados. É uma área estável e essencial, presente em praticamente toda empresa que guarda informação, do banco ao e-commerce.",
    oQueFaz: "Mantém bancos de dados rápidos, seguros e disponíveis: otimiza consultas, faz backups, controla acessos e modela a estrutura dos dados.",
    tarefasDiarias: ["Monitorar e otimizar a performance de consultas", "Planejar e testar rotinas de backup e recuperação", "Controlar acessos, usuários e permissões", "Modelar e ajustar a estrutura de tabelas e índices", "Garantir segurança, disponibilidade e integridade dos dados"],
    perfilIndicado: "Combina com quem é organizado, metódico, gosta de lógica e se preocupa com segurança e confiabilidade. Tem paciência para investigar problemas e prefere estabilidade a novidade constante.",
    habilidades: ["SQL avançado", "Modelagem de dados (normalização)", "Administração de SGBD (PostgreSQL, MySQL, Oracle ou SQL Server)", "Tuning e otimização de consultas", "Backup, recuperação e segurança", "Noções de Linux"],
    ferramentas: ["PostgreSQL", "MySQL", "SQL Server", "Oracle", "MongoDB", "Linux"],
    dificuldade: 4,
    cargos: ["DBA Júnior", "Administrador de Banco de Dados", "DBA Pleno", "DBA Sênior"],
    faixaSalarial: "Júnior R$ 4.500 a R$ 7.600, Pleno R$ 8.000 a R$ 11.700, Sênior R$ 12.000 a R$ 15.000 (Glassdoor 2026)",
    cursosGratuitos: ["Curso em Vídeo: MySQL (Gustavo Guanabara)", "W3Schools: SQL Tutorial (gratuito, em inglês)", "Microsoft Learn: trilhas de SQL Server e Azure SQL (gratuitas)", "Oracle Learning Explorer (gratuito)"],
    roadmapInicial: ["Aprender SQL do básico ao avançado", "Entender modelagem e normalização de dados", "Escolher e aprofundar em um SGBD (PostgreSQL é ótimo começo)", "Estudar índices, tuning e planos de execução", "Aprender backup, recuperação e controle de acesso", "Praticar em um banco real com volume de dados"],
    projetos: ["Modelar o banco de um sistema de e-commerce", "Otimizar consultas lentas em uma base grande", "Configurar rotina de backup e restauração"],
    termosEssenciais: ["SGBD", "Índice", "Normalização", "Backup", "Tuning", "Transação"],
    dicasIniciais: "Comece dominando SQL de verdade, depois aprofunde em um banco específico. PostgreSQL é gratuito, robusto e muito pedido. Entender índices e planos de execução é o que separa um DBA bom de um iniciante.",
    requiresGraduation: "opcional",
    tempoMedioFormacao: "9 a 18 meses até a primeira vaga",
    crescimentoMercado: "estavel",
    faculdadesRelacionadas: ["Análise e Desenvolvimento de Sistemas (ADS)", "Ciência da Computação", "Banco de Dados (tecnólogo)", "Sistemas de Informação"]
  },
  {
    id: "sre",
    ...
    icon: Gauge,
    tagClass: "tag-devops",
    descricaoCurta: "Mantém sistemas no ar com confiabilidade, automação e monitoramento em escala.",
    descricaoCompleta: "Site Reliability Engineering (SRE) é a junção de software com operações: o profissional usa programação para automatizar a operação e garantir que sistemas grandes fiquem estáveis, rápidos e disponíveis. Cuida de monitoramento, resposta a incidentes, capacidade e automação de infraestrutura. Surgiu no Google e é muito valorizado, costuma exigir experiência prévia em desenvolvimento ou infraestrutura, com salários altos.",
    oQueFaz: "Automatiza a operação de sistemas grandes, monitora disponibilidade e responde a incidentes para manter tudo estável e rápido.",
    tarefasDiarias: ["Monitorar disponibilidade, latência e erros dos sistemas", "Automatizar tarefas de operação e infraestrutura", "Responder a incidentes e fazer post-mortems", "Definir e acompanhar SLOs, SLIs e error budgets", "Melhorar escalabilidade e resiliência das aplicações"],
    perfilIndicado: "Combina com quem gosta de programar e de infraestrutura ao mesmo tempo, mantém a calma sob pressão e se importa com automação e confiabilidade. Costuma ser um passo depois de dev ou DevOps, não a primeira vaga.",
    habilidades: ["Linux e redes", "Uma linguagem de programação (Python ou Go)", "Containers e Kubernetes", "Observabilidade (logs, métricas e tracing)", "CI/CD e infraestrutura como código", "Resposta a incidentes"],
    ferramentas: ["Kubernetes", "Docker", "Prometheus", "Grafana", "Terraform", "AWS / GCP", "Git"],
    dificuldade: 5,
    cargos: ["Site Reliability Engineer Júnior", "Site Reliability Engineer Pleno", "Site Reliability Engineer Sênior", "Platform Engineer"],
    faixaSalarial: "Júnior R$ 5.000 a R$ 8.000, Pleno R$ 8.400 a R$ 17.000, Sênior R$ 14.000 a R$ 21.000 (Glassdoor 2026)",
    cursosGratuitos: ["Google SRE Books (sre.google/books, gratuitos online em inglês)", "Google Cloud: SRE e DevOps Engineer (Coursera, modo audit gratuito)", "LinuxTips: Descomplicando Docker e Kubernetes (YouTube, gratuito)", "KodeKloud: labs gratuitos de Linux e Kubernetes"],
    roadmapInicial: ["Dominar Linux e fundamentos de redes", "Aprender uma linguagem (Python ou Go)", "Entender containers e Kubernetes", "Estudar observabilidade (Prometheus e Grafana)", "Aprender infraestrutura como código (Terraform)", "Estudar SLOs, SLIs e cultura de confiabilidade"],
    projetos: ["Subir uma aplicação em Kubernetes com monitoramento", "Criar dashboards de métricas com Prometheus e Grafana", "Automatizar deploy com pipeline CI/CD e infraestrutura como código"],
    termosEssenciais: ["SLO", "SLI", "Error Budget", "Observabilidade", "Incidente", "Toil"],
    dicasIniciais: "SRE raramente é a primeira vaga: tenha base de programação ou infraestrutura antes. Os livros de SRE do Google são gratuitos e a melhor referência. Foque em automação, pois o objetivo é eliminar trabalho manual repetitivo.",
    requiresGraduation: "opcional",
    tempoMedioFormacao: "Costuma exigir experiência prévia em dev ou infra",
    crescimentoMercado: "alto",
    faculdadesRelacionadas: ["Análise e Desenvolvimento de Sistemas (ADS)", "Ciência da Computação", "Engenharia de Software", "Redes de Computadores"]
  },
  {
    id: "infraestrutura",
    ...
    icon: Network,
    tagClass: "tag-devops",
    descricaoCurta: "Mantém computadores, servidores e redes funcionando no dia a dia da empresa.",
    descricaoCompleta: "A área de suporte e infraestrutura cuida de tudo que faz a TI da empresa funcionar: computadores, servidores, redes, impressoras e acessos. É uma das portas de entrada mais acessíveis em tecnologia, ótima para quem está começando, pois dá visão ampla de como tudo se conecta e abre caminho para áreas como redes, cloud, DevOps e cibersegurança. O salário inicial é mais baixo que o de dev, mas a barreira de entrada também é menor.",
    oQueFaz: "Atende chamados, instala e configura equipamentos, administra redes e servidores e mantém a TI da empresa funcionando.",
    tarefasDiarias: ["Atender chamados e resolver problemas de usuários", "Instalar e configurar computadores, sistemas e impressoras", "Administrar redes, Wi-Fi e acessos", "Monitorar servidores e serviços", "Documentar procedimentos e gerenciar ativos de TI"],
    perfilIndicado: "Combina com quem gosta de resolver problemas práticos, tem paciência para atender pessoas e curiosidade para entender como máquinas e redes funcionam. Ótima primeira porta para quem quer entrar logo no mercado.",
    habilidades: ["Hardware e sistemas operacionais (Windows e Linux)", "Redes (TCP/IP, DNS, DHCP e Wi-Fi)", "Atendimento e comunicação", "Noções de servidores e cloud", "Active Directory e gestão de usuários", "Resolução de problemas"],
    ferramentas: ["Windows", "Linux", "Ferramentas de chamados (GLPI, Jira)", "Switches e roteadores", "Active Directory", "VMware / VirtualBox"],
    dificuldade: 2,
    cargos: ["Analista de Suporte Técnico", "Analista de Infraestrutura Júnior", "Analista de Redes", "Administrador de Sistemas"],
    faixaSalarial: "Júnior R$ 2.300 a R$ 4.000, Pleno R$ 4.500 a R$ 6.000, Sênior R$ 6.500 a R$ 9.000 (Glassdoor 2026)",
    cursosGratuitos: ["Cisco Networking Academy: Skills for All (cursos gratuitos de redes)", "Fundação Bradesco: Montagem e Manutenção de Computadores (gratuito)", "Google IT Support (Coursera, modo audit gratuito)", "Curso em Vídeo: Linux para iniciantes (gratuito)"],
    roadmapInicial: ["Aprender hardware e montagem de computadores", "Dominar Windows e o básico de Linux", "Estudar fundamentos de redes (TCP/IP, DNS e DHCP)", "Tirar uma certificação inicial (Cisco CCNA introdutório)", "Aprender administração de usuários e servidores", "Evoluir para redes, cloud ou cibersegurança"],
    projetos: ["Montar uma pequena rede doméstica ou de laboratório", "Configurar um servidor de arquivos em Linux", "Documentar o inventário e os procedimentos de um setor"],
    termosEssenciais: ["TCP/IP", "DNS", "DHCP", "Active Directory", "Chamado", "Servidor"],
    dicasIniciais: "É a porta de entrada mais acessível da TI. Aproveite para ver tudo de perto e descobrir o que mais gosta. Os cursos gratuitos da Cisco e da Fundação Bradesco são um ótimo começo. Use o suporte como trampolim para redes, cloud ou segurança.",
    requiresGraduation: "opcional",
    tempoMedioFormacao: "3 a 9 meses até a primeira vaga",
    crescimentoMercado: "estavel",
    faculdadesRelacionadas: ["Redes de Computadores", "Análise e Desenvolvimento de Sistemas (ADS)", "Gestão de TI", "Sistemas de Informação"]
  },
  {
    id: "analise-sistemas",
    ...
    icon: FileSearch,
    tagClass: "tag-gestao",
    descricaoCurta: "Faz a ponte entre as necessidades do negócio e a solução técnica que será construída.",
    descricaoCompleta: "O analista de sistemas entende o problema do negócio e o traduz em requisitos claros para o time de desenvolvimento. Levanta necessidades com usuários, documenta processos, modela soluções e acompanha a entrega para garantir que o que foi construído resolve o problema certo. É uma área que mistura tecnologia, comunicação e visão de processos, ótima para quem gosta de organizar e conversar com pessoas.",
    oQueFaz: "Levanta requisitos com o negócio, documenta processos e modela soluções, fazendo a ponte entre usuários e o time de desenvolvimento.",
    tarefasDiarias: ["Levantar requisitos com usuários e áreas de negócio", "Documentar processos, regras e fluxos", "Modelar soluções (diagramas, UML e casos de uso)", "Alinhar expectativas entre negócio e desenvolvimento", "Acompanhar testes e validar entregas"],
    perfilIndicado: "Combina com quem gosta de organizar ideias, conversar com pessoas e entender processos. Une raciocínio lógico com boa comunicação. Ideal para quem curte tecnologia mas não quer passar o dia inteiro programando.",
    habilidades: ["Levantamento e análise de requisitos", "Modelagem de processos e UML", "Lógica de programação e SQL básico", "Comunicação e escrita clara", "Metodologias ágeis (Scrum e Kanban)", "Visão de negócio"],
    ferramentas: ["Jira", "Confluence", "Figma / Miro", "Diagramas (UML e BPMN)", "SQL", "Trello"],
    dificuldade: 3,
    cargos: ["Analista de Sistemas Júnior", "Analista de Requisitos", "Analista de Negócios", "Analista de Sistemas Sênior"],
    faixaSalarial: "Júnior R$ 3.200 a R$ 6.000, Pleno R$ 5.600 a R$ 9.600, Sênior R$ 11.000 a R$ 18.000 (Glassdoor 2026)",
    cursosGratuitos: ["Fundação Bradesco: Análise de Sistemas e UML (gratuito)", "Curso em Vídeo: Algoritmos e Lógica de Programação (gratuito)", "DIO: bootcamps gratuitos de fundamentos", "Coursera: Engenharia de Requisitos (modo audit gratuito)"],
    roadmapInicial: ["Entender lógica de programação e SQL básico", "Aprender levantamento e documentação de requisitos", "Estudar modelagem de processos e UML", "Conhecer metodologias ágeis (Scrum e Kanban)", "Praticar escrevendo requisitos e casos de uso", "Construir um portfólio de documentação de projetos"],
    projetos: ["Documentar os requisitos de um app real", "Modelar o fluxo de um processo em BPMN", "Escrever casos de uso e histórias de usuário de um sistema"],
    termosEssenciais: ["Requisito", "UML", "Caso de Uso", "Stakeholder", "Backlog", "Processo"],
    dicasIniciais: "Comunicação é tão importante quanto a parte técnica aqui. Aprenda a fazer boas perguntas e a documentar com clareza. Saber um pouco de programação e SQL ajuda muito a conversar com o time de desenvolvimento.",
    requiresGraduation: "recomendado",
    tempoMedioFormacao: "12 a 24 meses até a primeira vaga",
    crescimentoMercado: "estavel",
    faculdadesRelacionadas: ["Análise e Desenvolvimento de Sistemas (ADS)", "Sistemas de Informação", "Engenharia de Software", "Ciência da Computação"]
  },
  {
    id: "blockchain",
    ...
    icon: Blocks,
    tagClass: "tag-backend",
    descricaoCurta: "Desenvolve contratos inteligentes e aplicações descentralizadas sobre blockchain.",
    descricaoCompleta: "O desenvolvedor blockchain cria aplicações que rodam em redes descentralizadas, como a Ethereum. Escreve contratos inteligentes (smart contracts) que executam regras automaticamente e sem intermediários, usados em finanças (DeFi), tokens, NFTs e identidade digital. É uma área de nicho, mais volátil, mas com salários competitivos e demanda puxada por projetos cripto e iniciativas como o Drex do Banco Central.",
    oQueFaz: "Escreve e audita contratos inteligentes em Solidity e integra aplicações web a redes blockchain descentralizadas.",
    tarefasDiarias: ["Escrever e testar contratos inteligentes (Solidity)", "Integrar aplicações web com a blockchain", "Auditar e cuidar da segurança dos contratos", "Trabalhar com carteiras, tokens e padrões (ERC-20 e ERC-721)", "Acompanhar gás, custos e otimização on-chain"],
    perfilIndicado: "Combina com quem tem base de programação, curiosidade por finanças e tecnologia descentralizada e tolerância a um mercado volátil. Segurança é levada a sério, pois um erro em contrato pode custar caro.",
    habilidades: ["Solidity", "Lógica de programação e JavaScript/TypeScript", "Conceitos de blockchain e criptografia", "Smart contracts e padrões ERC", "Web3 (ethers.js, wagmi)", "Segurança e auditoria de contratos"],
    ferramentas: ["Solidity", "Hardhat / Foundry", "ethers.js", "MetaMask", "Remix IDE", "Node.js"],
    dificuldade: 4,
    cargos: ["Desenvolvedor Blockchain Júnior", "Desenvolvedor Solidity", "Engenheiro Web3", "Desenvolvedor Blockchain Sênior"],
    faixaSalarial: "Júnior R$ 4.000 a R$ 8.000, Pleno R$ 8.000 a R$ 12.000, Sênior acima de R$ 15.000 (Glassdoor 2026)",
    cursosGratuitos: ["CryptoZombies (gratuito, Solidity interativo no navegador)", "Alchemy University: Solidity e Ethereum Developer Bootcamp (gratuito)", "freeCodeCamp: curso de Solidity e smart contracts (YouTube, Patrick Collins)", "Ethereum.org: documentação para desenvolvedores (gratuita)"],
    roadmapInicial: ["Aprender lógica de programação e JavaScript", "Entender como funciona uma blockchain", "Aprender Solidity com o CryptoZombies", "Criar e fazer deploy de contratos de teste (Remix)", "Integrar um contrato com uma aplicação web (Web3)", "Estudar segurança e auditoria de smart contracts"],
    projetos: ["Token ERC-20 próprio em rede de teste", "Aplicação de votação on-chain", "Marketplace simples de NFT (ERC-721)"],
    termosEssenciais: ["Smart Contract", "Solidity", "Gas", "Token", "DApp", "Wallet"],
    dicasIniciais: "Tenha base sólida de programação antes de partir para blockchain. Comece pelo CryptoZombies e pela Alchemy University, ambos gratuitos. Segurança é prioridade absoluta, pois um bug pode causar prejuízo irreversível, então estude auditoria desde cedo.",
    requiresGraduation: "opcional",
    tempoMedioFormacao: "12 a 24 meses (costuma exigir base de dev)",
    crescimentoMercado: "medio",
    faculdadesRelacionadas: ["Ciência da Computação", "Engenharia de Software", "Análise e Desenvolvimento de Sistemas (ADS)", "Sistemas de Informação"]
  },
  {
    id: "iot",
    ...
    icon: Cpu,
    tagClass: "tag-backend",
    descricaoCurta: "Programa o software que roda dentro de dispositivos físicos e objetos conectados.",
    descricaoCompleta: "Sistemas embarcados e IoT (Internet das Coisas) são o software que roda dentro de dispositivos físicos: de uma máquina de café e um carro até sensores industriais e dispositivos vestíveis. O profissional programa microcontroladores, integra sensores, cuida de comunicação e de consumo de energia, e conecta os dispositivos à internet. Combina programação com eletrônica e tem demanda crescente com a expansão da IoT e da indústria 4.0.",
    oQueFaz: "Programa firmware para microcontroladores, integra sensores e conecta dispositivos físicos à internet.",
    tarefasDiarias: ["Programar microcontroladores (firmware em C e C++)", "Integrar sensores, atuadores e periféricos", "Implementar comunicação (Wi-Fi, Bluetooth e MQTT)", "Otimizar consumo de memória e energia", "Testar e depurar hardware e software juntos"],
    perfilIndicado: "Combina com quem gosta de programação e também de eletrônica e do mundo físico, tem paciência para depurar problemas de hardware e curte ver o código controlando algo real. Matemática e lógica ajudam bastante.",
    habilidades: ["Linguagem C e C++", "Eletrônica básica", "Microcontroladores (Arduino, ESP32 e STM32)", "Protocolos de comunicação (I2C, SPI e MQTT)", "RTOS e gerenciamento de memória", "Depuração de hardware"],
    ferramentas: ["Arduino IDE", "ESP32", "Raspberry Pi", "C / C++", "PlatformIO", "Osciloscópio e multímetro"],
    dificuldade: 4,
    cargos: ["Desenvolvedor de Firmware Júnior", "Engenheiro de Sistemas Embarcados", "Desenvolvedor IoT", "Engenheiro de Firmware Sênior"],
    faixaSalarial: "Júnior R$ 4.000 a R$ 7.000, Pleno R$ 7.000 a R$ 13.000, Sênior R$ 12.000 a R$ 18.000 (Glassdoor 2026)",
    cursosGratuitos: ["Arduino: tutoriais e documentação oficiais (gratuitos)", "Cisco Networking Academy: Introduction to IoT (gratuito)", "Curso em Vídeo: Linguagem C (Gustavo Guanabara, base de firmware)", "Portal Embarcados: artigos e tutoriais gratuitos (embarcados.com.br)"],
    roadmapInicial: ["Aprender lógica de programação e linguagem C", "Estudar eletrônica básica", "Começar com Arduino e projetos simples", "Evoluir para ESP32 e conectividade (Wi-Fi e MQTT)", "Aprender protocolos de comunicação (I2C e SPI)", "Construir um projeto de IoT completo conectado à nuvem"],
    projetos: ["Estação meteorológica com sensores e Wi-Fi", "Automação de luz ou irrigação com ESP32", "Dispositivo que envia dados para um dashboard na nuvem"],
    termosEssenciais: ["Microcontrolador", "Firmware", "Sensor", "GPIO", "MQTT", "RTOS"],
    dicasIniciais: "Comece com Arduino, que é barato e tem comunidade enorme, depois migre para o ESP32 (Wi-Fi embutido). Aprenda C de verdade, pois é a linguagem do firmware. Ter o hardware na mão e construir projetos físicos é o que mais acelera o aprendizado.",
    requiresGraduation: "recomendado",
    tempoMedioFormacao: "12 a 24 meses até a primeira vaga",
    crescimentoMercado: "alto",
...
export const cursosGratuitos = [
  ...
  },
  {
    ...
    descricao: "Curso introdutório de Ciência da Computação de Harvard. Cobre lógica, C, Python, SQL e web com projetos práticos.",
    motivoIndicacao: "Base sólida de fundamentos que serve para qualquer área de TI, gratuita e reconhecida mundialmente.",
    oQueAprende: ["Lógica de programação", "C e Python", "SQL", "Estruturas de dados"],
  ...
  },
  {
    ...
    idioma: "Inglês",
    descricao: "Trilha gratuita e completa de desenvolvimento web full stack, baseada em prática e construção de projetos reais.",
    motivoIndicacao: "Currículo aberto, atualizado pela comunidade e 100% baseado em projetos, ótimo para portfólio.",
    oQueAprende: ["HTML, CSS e JavaScript", "Git e GitHub", "Node.js", "Projetos full stack"],
  ...
  },
  {
    ...
    duracao: "300 horas",
    idioma: "Inglês (com suporte em português)",
    descricao: "Certificação gratuita de JavaScript, do básico à manipulação de dados e algoritmos, com exercícios e projetos.",
    motivoIndicacao: "Sequência natural depois de HTML e CSS, com certificado gratuito e prática constante.",
    oQueAprende: ["JavaScript moderno", "Algoritmos", "Estruturas de dados", "Projetos certificados"],
  ...
  },
  {
    ...
    duracao: "300 horas",
    idioma: "Inglês (com suporte em português)",
    descricao: "Certificação gratuita de Python aplicada a computação científica, com projetos práticos de manipulação de dados.",
    motivoIndicacao: "Boa porta de entrada em Python para quem quer seguir para dados, com certificado gratuito.",
    oQueAprende: ["Python", "Estruturas de dados", "Lógica aplicada", "Projetos certificados"],
  ...
  },
  {
    ...
    idioma: "Inglês (com suporte em português)",
    descricao: "Trilha gratuita e prática de bancos de dados relacionais e SQL, executada direto no terminal com projetos.",
    motivoIndicacao: "SQL é cobrado em praticamente toda vaga de dados, e aqui o aprendizado é totalmente mão na massa.",
    oQueAprende: ["SQL", "Bancos relacionais", "Linha de comando", "Projetos práticos"],
  ...
  },
  {
    ...
    duracao: "300 horas",
    idioma: "Inglês (com suporte em português)",
    descricao: "Certificação gratuita com React, Redux, Bootstrap e Sass, construindo interfaces e componentes reutilizáveis.",
    motivoIndicacao: "React é o framework front-end mais pedido no mercado, e aqui você pratica com projetos certificados.",
  ...
  },
  {
    ...
    idioma: "Inglês (legendas em português)",
    descricao: "Certificado profissional de UX do Google, do processo de pesquisa ao protótipo no Figma e Adobe XD.",
    motivoIndicacao: "Trilha estruturada de UX para iniciantes, gratuita para auditar e reconhecida no mercado.",
    oQueAprende: ["Processo de UX", "Pesquisa com usuários", "Wireframes e protótipos", "Figma"],
  ...
  },
  {
    ...
    descricao: "Curso introdutório e gratuito sobre o que é inteligência artificial, seus conceitos e implicações, sem exigir programação.",
    motivoIndicacao: "Ótimo primeiro contato com IA para entender os conceitos antes de partir para a prática técnica.",
    oQueAprende: ["O que é IA", "Aprendizado de máquina", "Aplicações reais", "Limites e ética"],
  ...
  },
  {
    ...
    descricao: "Curso introdutório e gratuito sobre fundamentos de cloud na AWS: serviços principais, segurança, preços e suporte.",
    motivoIndicacao: "Primeiro passo para quem quer cloud, e prepara para a certificação Cloud Practitioner.",
    oQueAprende: ["Fundamentos de cloud", "Serviços AWS", "Segurança", "Modelo de preços"],
  ...
  },
  {
    ...
    idioma: "Inglês",
    descricao: "Tutorial oficial e gratuito do Flutter para criar seu primeiro aplicativo multiplataforma do zero.",
    motivoIndicacao: "Maneira prática de começar em mobile com uma única base de código para Android e iOS.",
    oQueAprende: ["Dart básico", "Widgets do Flutter", "Layout e estado", "Primeiro app"],
  ...
  },
  {
    ...
    duracao: "300 horas",
    idioma: "Inglês (com suporte em português)",
    descricao: "Certificação gratuita de back-end com Node.js e Express, criando e consumindo APIs e trabalhando com MongoDB.",
    motivoIndicacao: "Caminho prático para quem já sabe JavaScript e quer construir o lado servidor de uma aplicação.",
  ...
  },
  {
    ...
    duracao: "300 horas",
    idioma: "Inglês (com suporte em português)",
    descricao: "Certificação gratuita de análise de dados com Python, usando pandas, NumPy e visualização para explorar conjuntos reais.",
    motivoIndicacao: "Sequência natural depois de Python para quem quer seguir na carreira de dados.",
  ...
  },
  {
    ...
    duracao: "300 horas",
    idioma: "Inglês (com suporte em português)",
    descricao: "Certificação gratuita de segurança da informação com Node.js, HelmetJS e testes de penetração introdutórios.",
    motivoIndicacao: "Primeiro contato prático com segurança aplicada para quem já programa.",
    oQueAprende: ["Segurança em apps web", "HelmetJS", "Pentest básico", "Boas práticas"],
  ...
  },
  {
    ...
    duracao: "~8 horas",
    idioma: "Português",
    descricao: "Trilha gratuita e oficial da Microsoft para aprender a lógica e a sintaxe de C# do zero, direto no navegador.",
    motivoIndicacao: "Ótima porta de entrada para o ecossistema .NET, muito usado em empresas no Brasil.",
    oQueAprende: ["Sintaxe de C#", "Variáveis e tipos", "Lógica e laços", "Console apps"],
  ...
  },
  {
    ...
    idioma: "Inglês",
    descricao: "Curso oficial e gratuito do Google para criar apps Android nativos com Kotlin e Jetpack Compose.",
    motivoIndicacao: "Caminho oficial e atualizado para quem quer desenvolvimento mobile nativo Android.",
  ...
  },
  {
    ...
    duracao: "~3 horas",
    idioma: "Inglês",
    descricao: "Microcurso gratuito e prático do Kaggle sobre os fundamentos de machine learning, com notebooks no navegador.",
    motivoIndicacao: "Aprende treinando modelos de verdade em conjuntos reais, sem precisar instalar nada.",
    oQueAprende: ["Modelos de ML", "Treino e validação", "Overfitting", "Random Forest"],
  ...
  },
  {
    ...
    duracao: "~6 meses (ritmo leve)",
    idioma: "Inglês (legendas em português)",
    descricao: "Certificado profissional do Google sobre análise de dados, do entendimento do problema à visualização e SQL.",
    motivoIndicacao: "Trilha estruturada para quem quer entrar em dados sem experiência prévia, gratuita para auditar.",
    oQueAprende: ["Processo de análise", "SQL", "Planilhas", "Visualização e R"],
  ...
  },
  {
    ...
    duracao: "~10 horas",
    idioma: "Português",
    descricao: "Trilha gratuita e oficial sobre fundamentos de nuvem na Azure: serviços, segurança, governança e preços.",
    motivoIndicacao: "Alternativa à AWS para fundamentos de cloud, prepara para a certificação AZ-900.",
    oQueAprende: ["Conceitos de cloud", "Serviços Azure", "Segurança e identidade", "Custos"],
...
export const faculdades = {
  cursos: [
    ...
    },
    {
      ...
      duracao: "5 anos",
      tipo: "Bacharelado",
      oQueEstuda: "Hardware e software, eletrônica, circuitos, sistemas embarcados, programação, redes e estruturas de dados.",
      perfilIndicado: "Quem gosta de matemática e física e quer atuar na fronteira entre hardware e software.",
      diferencas: "Mais próxima da engenharia e do hardware que a Ciência da Computação, com eletrônica e sistemas embarcados.",
      areasAtuacao: ["Desenvolvedor", "Engenheiro de Sistemas Embarcados", "Engenheiro de Hardware", "Engenheiro de Software"],
      matematica: "Alto",
      programacao: "Alto",
      pontoPositivos: ["Forte em hardware e software", "Boa empregabilidade em várias indústrias", "Base sólida de engenharia"],
      pontosAtencao: ["5 anos de duração", "Matemática e física pesadas", "Carga de eletrônica que nem todo mundo curte"],
    },
    {
      nome: "Redes de Computadores",
      duracao: "2-3 anos",
      tipo: "Tecnólogo",
      oQueEstuda: "Infraestrutura de redes, protocolos, servidores, administração de sistemas e fundamentos de segurança.",
      perfilIndicado: "Quem quer trabalhar com infraestrutura, servidores e conectividade.",
      diferencas: "Foco em infraestrutura e operação, não em desenvolvimento de software.",
      areasAtuacao: ["Analista de Redes", "Administrador de Sistemas", "Suporte de Infraestrutura", "Analista de Cloud"],
      matematica: "Médio",
      programacao: "Médio",
      pontoPositivos: ["Curto e prático", "Base para certificações (Cisco, AWS)", "Porta de entrada para cloud e DevOps"],
      pontosAtencao: ["Pouco foco em programação", "Mercado costuma pedir certificações além do diploma"],
    },
    {
      nome: "Segurança da Informação",
      duracao: "2-3 anos",
      tipo: "Tecnólogo",
      oQueEstuda: "Fundamentos de cibersegurança, redes, criptografia, análise de vulnerabilidades e resposta a incidentes.",
      perfilIndicado: "Quem quer entrar em cibersegurança com uma formação direcionada.",
      diferencas: "Especializado em segurança desde o início, diferente de cursos de TI generalistas.",
      areasAtuacao: ["Analista de Segurança", "Analista SOC", "Pentester Júnior", "Analista de Conformidade"],
      matematica: "Médio",
      programacao: "Médio-Alto",
      pontoPositivos: ["Foco em área aquecida e bem paga", "Curto", "Base para certificações de segurança"],
      pontosAtencao: ["Mercado júnior exige prática e laboratórios próprios", "Menos profundidade teórica que um bacharelado em CC"],
    },
    {
      nome: "Ciência de Dados",
      duracao: "2-3 anos",
      tipo: "Tecnólogo",
      oQueEstuda: "Estatística aplicada, programação (Python e R), SQL, visualização de dados e introdução a machine learning.",
      perfilIndicado: "Quem quer entrar em dados de forma direcionada e prática.",
      diferencas: "Foco em dados desde o início, mais aplicado que um bacharelado generalista.",
      areasAtuacao: ["Analista de Dados", "Cientista de Dados Júnior", "Analista de BI", "Engenheiro de Dados Júnior"],
      matematica: "Alto",
      programacao: "Médio-Alto",
      pontoPositivos: ["Direcionado a uma área aquecida", "Prático", "Boa base de estatística e programação"],
      pontosAtencao: ["Estatística pode ser desafiadora", "Cargos sênior costumam pedir mais matemática ou pós"],
    },
    {
      nome: "Gestão da Tecnologia da Informação",
      duracao: "2 anos",
      tipo: "Tecnólogo",
      oQueEstuda: "Governança de TI, gestão de projetos, processos, infraestrutura e fundamentos de desenvolvimento e negócios.",
      perfilIndicado: "Quem quer atuar na gestão e coordenação de TI mais que na codificação.",
      diferencas: "Foco em gestão e negócio, com menos programação que cursos de desenvolvimento.",
      areasAtuacao: ["Gestor de TI", "Analista de Projetos", "Product Owner", "Consultor de TI"],
      matematica: "Médio",
      programacao: "Médio",
      pontoPositivos: ["Visão de gestão e negócio", "Curto", "Boa ponte para liderança"],
      pontosAtencao: ["Pouca profundidade técnica em código", "Mercado júnior técnico pode preferir cursos de desenvolvimento"],
    },
    {
      nome: "Sistemas para Internet",
      duracao: "2 anos",
      tipo: "Tecnólogo",
      oQueEstuda: "Desenvolvimento web front-end e back-end, banco de dados, design de interfaces, hospedagem e deploy.",
      perfilIndicado: "Quem quer focar em desenvolvimento web e entrar rápido no mercado.",
      diferencas: "Foco específico em web, mais direcionado que o ADS.",
      areasAtuacao: ["Desenvolvedor Web", "Desenvolvedor Front-end", "Desenvolvedor Back-end", "Desenvolvedor Full Stack"],
      matematica: "Médio",
      programacao: "Alto",
      pontoPositivos: ["Foco prático em web", "Curto", "Alta demanda por desenvolvedores web"],
      pontosAtencao: ["Menos abrangente que o ADS", "Pouco aprofundamento teórico"],
    },
  ],
};
