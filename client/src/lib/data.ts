...
const plataformasBase = [
  ...
  },
  {
    ...
    pontosFortes: ["Instantâneo para abrir e praticar", "Visual, entende as propriedades na prática", "Curto para fazer numa sentada", "Ótimo depois de ler o básico de MDN/HTML"],
  ...
  },
  {
    ...
    idioma: "Inglês",
    areasFortes: ["Front-end", "CSS"],
    pontosFortes: ["Seletores específicos e combinadores ficam claros rápido", "Curto e direto"],
    limitacoes: ["Foco apenas em seletores", "Interface simples, mas funciona bem"],
  ...
  },
  {
    ...
    pontosFortes: ["Gamificação que incentiva o estudo", "Progressão gradual", "Conteúdos voltados também para escolas"],
    limitacoes: ["O plano pago amplia bastante o curso", "Boa parte do produto principal é em inglês"],
    melhorPerfil: "Adolescente ou adulto que aprende melhor jogando do que só assistindo a vídeos.",
    nivelIdeal: "Iniciante",
    certificado: true,
    trilhasOrganizadas: true,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    pontosFortes: ["Aprendizado ativo resolvendo problemas", "Várias linguagens", "Comunidade e torneios", "Gamificação leve"],
    limitacoes: ["Pode cansar quem é iniciante absoluto (melhor usar após a primeira semana programando)", "Não tem curso linear tradicional"],
    melhorPerfil: "Quem já mexeu um pouco em variáveis, if e loops e quer treinar resolvendo desafios.",
    nivelIdeal: "Iniciante a avançado",
    certificado: false,
    trilhasOrganizadas: false,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    descricao: "Missões em Python e JavaScript dentro de cenários gamificados para subir de nível técnico.",
    tipo: "Gratuita",
    idioma: "Inglês",
    areasFortes: ["Programação", "Python", "Games"],
    pontosFortes: ["Mistura enigma e código de forma divertida", "Compara suas soluções com as de outros", "Bom segundo passo depois do Python básico"],
    limitacoes: ["Poucas linguagens suportadas", "Em inglês"],
    melhorPerfil: "Quem terminou o primeiro curso de Python e quer se desafiar em missões estruturadas.",
    nivelIdeal: "Iniciante a intermediário",
    certificado: false,
    trilhasOrganizadas: true,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    descricao: "Otimize elevadores escrevendo JavaScript. Um ótimo playground para sintaxe, objetos simples e lógica de filas.",
    tipo: "Gratuita",
    idioma: "Inglês",
    areasFortes: ["Programação", "JavaScript", "Lógica", "Games"],
    pontosFortes: ["Foco em um problema claro", "Dá para refatorar e ver as métricas", "Diferente das katas triviais"],
    limitacoes: ["Tema bem específico", "Precisa ler uma documentação curta no começo"],
    melhorPerfil: "Quem está em JavaScript básico ou intermediário e quer revisar código realista em pequena escala.",
    nivelIdeal: "Iniciante a intermediário",
    certificado: false,
    trilhasOrganizadas: false,
    boaParaIniciantes: false,
  ...
  },
  {
    ...
    pontosFortes: ["Motiva a aprender algo que costuma ser maçante", "Os mnemônicos ajudam a fixar os comandos"],
    limitacoes: ["O início é grátis, depois é pago", "Não é prioridade antes da primeira linguagem"],
    melhorPerfil: "Quem vai mexer em servidor Linux ou editor remoto e quer dominar o Vim.",
    nivelIdeal: "Iniciante a intermediário",
    certificado: false,
    trilhasOrganizadas: true,
    boaParaIniciantes: false,
  ...
  },
  {
    ...
    pontosFortes: ["Feedback de mentores humanos no plano com mentoria", "Muitas linguagens disponíveis", "Exercícios curtos que reforçam o aprendizado"],
    limitacoes: ["O ritmo depende de você", "A mentoria pode exigir paciência para receber retorno"],
    melhorPerfil: "Quem prefere problemas curtos e sugestões de melhoria antes de partir para projetos grandes.",
    nivelIdeal: "Iniciante a avançado",
    certificado: false,
    trilhasOrganizadas: true,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    pontosFortes: ["Blocos curtos que cabem em uma rotina cheia", "O ranking motiva", "Dá para ver outras soluções depois de resolver"],
    limitacoes: ["Pode virar obsessão sem um projeto de portfólio", "Pode frustrar logo na primeira semana"],
    melhorPerfil: "Quem tem uma base mínima e quer treinar 20 minutos por dia para afiar sintaxe e lógica.",
  ...
  },
  {
    ...
    pontosFortes: ["Briefing e assets já prontos", "Compara soluções", "Rende bons projetos para o GitHub"],
    limitacoes: ["Desafios avançados e arquivos Figma ficam nos planos pagos"],
    melhorPerfil: "Quem já sabe HTML, CSS e JavaScript básico e quer sair do tutorial copiado.",
    nivelIdeal: "Iniciante a intermediário",
    certificado: false,
    trilhasOrganizadas: true,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    descricao: "IDE no navegador com deploy fácil, templates e até assistente de IA integrado. Rápido para iterar um projeto sem instalar a toolchain inteira.",
    tipo: "Híbrida",
    idioma: "Inglês (interface) / projetos na linguagem que você escolher",
    areasFortes: ["Programação", "Front-end", "Back-end", "Cloud leve"],
    pontosFortes: ["Ambiente igual para todo mundo, útil em turmas", "Deploy simples para começar", "Muitos templates"],
    limitacoes: ["O plano grátis pode limitar projetos pesados", "Requer internet"],
    melhorPerfil: "Quem tem um notebook fraco e quer programar na nuvem sem instalar toolchain.",
    nivelIdeal: "Iniciante a intermediário",
    certificado: false,
    trilhasOrganizadas: false,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    pontosFortes: ["Cultura aberta de clonar e remixar projetos", "Hospeda uma mini API rapidinho", "Bom para trabalho em grupo"],
    limitacoes: ["Não ensina trilhas longas sozinho", "No plano grátis o projeto dorme e tem cold start"],
    melhorPerfil: "Quem quer publicar a primeira landing animada sem cartão de crédito no primeiro deploy.",
    nivelIdeal: "Iniciante",
    certificado: false,
    trilhasOrganizadas: false,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    pontosFortes: ["Pensado para o celular", "Trilhas por linguagem", "O plano grátis basta nos primeiros dias"],
    limitacoes: ["Sozinho não basta para uma carreira sênior", "Tem anúncios no plano grátis"],
  ...
  },
  {
    ...
    pontosFortes: ["Visual interativo forte", "Boa preparação antes de cursos mais teóricos"],
    limitacoes: ["O catálogo maior fica na assinatura paga", "Não substitui um portfólio técnico"],
    melhorPerfil: "Quem quer perder o medo de matemática e lógica antes de dados ou Ciência da Computação.",
    nivelIdeal: "Iniciante",
    certificado: true,
    trilhasOrganizadas: true,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    pontosFortes: ["Integração opcional com o IntelliJ", "Os projetos crescem em complexidade"],
    limitacoes: ["O plano grátis tem limites de projeto", "Não é para o primeiro dia absoluto"],
    melhorPerfil: "Quem se motiva mais com projetos longos do que com maratonas de vídeo.",
    nivelIdeal: "Iniciante a intermediário",
    certificado: true,
    trilhasOrganizadas: true,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    pontosFortes: ["Ótimo para guiar o próprio estudo", "Não reinventa nada, só organiza e indica recursos"],
    limitacoes: ["Não ensina o conteúdo em si, só dá o mapa", "Algumas escolhas de tecnologia variam por empresa"],
  ...
  },
  {
    ...
    pontosFortes: ["Treina reconhecimento de padrões", "Discussões da comunidade com soluções", "Tem competições"],
    limitacoes: ["Focar só nisso no primeiro mês pode causar burnout", "Em inglês"],
    melhorPerfil: "Quem já fez projetos pequenos completos antes de focar só em treino de algoritmos.",
  ...
  },
  {
    ...
    pontosFortes: ["Cursos abertos para acompanhar de graça", "Exercícios com correção automática", "Bom recurso complementar"],
    limitacoes: ["Interface menos polida que os grandes marketplaces", "A qualidade varia muito conforme o autor"],
  ...
  },
  {
    ...
    logoUrl: "https://www.google.com/s2/favicons?domain=mystery.knightlab.com&sz=128",
    descricao: "Investigue um crime escrevendo consultas SQL para encontrar o culpado dentro de um banco de dados fictício.",
    tipo: "Gratuita",
    idioma: "Inglês",
    areasFortes: ["Dados", "SQL"],
    pontosFortes: ["Aprende SQL resolvendo um caso", "Roda no navegador sem instalar nada", "Curto e envolvente"],
    limitacoes: ["Cobre consultas SQL básicas a intermediárias", "Em inglês", "Sem certificado"],
    melhorPerfil: "Quem está começando em SQL e quer praticar SELECT, JOIN e WHERE de forma divertida.",
    nivelIdeal: "Iniciante a intermediário",
    certificado: false,
    trilhasOrganizadas: false,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    logoUrl: "https://www.google.com/s2/favicons?domain=regexcrossword.com&sz=128",
    descricao: "Palavras-cruzadas em que cada pista é uma expressão regular, treinando regex na prática.",
    tipo: "Gratuita",
    idioma: "Inglês",
    areasFortes: ["Programação", "Lógica"],
    pontosFortes: ["Fixa a sintaxe de regex jogando", "Dificuldade progressiva", "Roda no navegador"],
    limitacoes: ["Foco exclusivo em regex", "Em inglês", "Sem certificado"],
    melhorPerfil: "Quem quer entender expressões regulares sem decorar tabela de símbolos.",
    nivelIdeal: "Iniciante a intermediário",
    certificado: false,
    trilhasOrganizadas: false,
    boaParaIniciantes: true,
  ...
  },
  {
    ...
    descricao: "Desafios em que você reproduz uma imagem-alvo usando o menor código CSS possível, com ranking.",
    tipo: "Gratuita",
    idioma: "Inglês",
    areasFortes: ["Front-end", "CSS"],
    pontosFortes: ["Treina CSS de forma competitiva", "Feedback visual imediato", "Comunidade e ranking"],
    limitacoes: ["Foco em CSS visual, não em projetos completos", "Em inglês", "Recursos extras no plano pago"],
    melhorPerfil: "Quem já sabe CSS básico e quer afiar precisão e criatividade.",
