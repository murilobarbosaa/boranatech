...
export const uxui: RoadmapV2 = {
  ...
  sections: [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          content:
            "Hora de aplicar tudo numa tela de verdade. Até aqui você estruturou (wireframes) e estudou os princípios visuais; agora junte os dois numa interface de **alta fidelidade**, com cor, tipografia, espaçamento e componentes definidos, pronta pra parecer um produto real.\n\nUm projeto excelente pra isso é desenhar uma tela rica em informação, como um painel ou dashboard, onde você exercita o que mais importa em UI: organizar muita coisa com clareza. Você vai precisar de hierarquia (o que o usuário olha primeiro), de um sistema de espaçamento consistente, de uma paleta com cor usada com intenção e de uma escala tipográfica bem aplicada. É o tipo de tela que obriga a tomar todas as decisões visuais juntas.\n\nTrabalhe a partir de um wireframe seu, evoluindo-o pra o visual final no Figma, usando auto layout e componentes pra manter consistência. Capriche nos detalhes que separam o amador do profissional: alinhamento impecável, contraste adequado, espaço em branco generoso.\n\nO projeto abaixo te guia na construção de um dashboard no Figma, exatamente o exercício que consolida esta seção. Use-o como roteiro. Uma tela de alta fidelidade bem resolvida é uma das peças mais fortes que você pode ter no portfólio, porque mostra domínio visual de forma imediata pra quem olha.",
    ...
    },
    {
      ...
      description:
        "A reta final: tornar o design clicável, validar com pessoas reais e mostrar o trabalho.",
      level: "avancado",
      children: [
        {
