...
export const womenArea = {
  ...
  tips: [
    ...
    "Comece publicando pequenos projetos no GitHub, porque um histórico visível vale mais que um currículo perfeito.",
    "Aprenda em público: postar o que você estudou hoje cria rede de apoio e fixa o conhecimento.",
    "Foque em uma trilha por vez, pois pular entre linguagens no início costuma gerar mais ansiedade do que progresso.",
    "Trate a síndrome da impostora como sinal de crescimento, não como veredito sobre a sua capacidade.",
    "Entre em pelo menos uma comunidade de mulheres na área antes de se candidatar a vagas, porque indicação abre mais portas que aplicação a frio.",
    "Pratique explicar o que você construiu em voz alta, já que comunicar bem o código costuma pesar tanto quanto escrevê-lo.",
    "Guarde um registro das suas conquistas semanais para consultar nos dias em que bater a dúvida.",
    "Candidate-se a vagas mesmo sem cumprir todos os requisitos, porque a lista da empresa quase sempre é uma lista de desejos.",
    "Busque uma mentora que já trilhou o caminho que você quer percorrer, em vez de tentar descobrir tudo sozinha.",
    "Valorize as habilidades da sua carreira anterior, pois experiência com pessoas, processos e produtos é ouro em times de tecnologia.",
  ...
  communities: [
    ...
    {
      name: "PrograMaria",
      desc: "Negócio de impacto social que forma e conecta mulheres e pessoas de gêneros minorizados ao mercado de tecnologia.",
      url: "https://www.programaria.org/",
    },
    {
      name: "PyLadies São Paulo",
      desc: "Grupo paulistano das PyLadies com cursos e encontros gratuitos de Python para iniciantes e avançadas.",
      url: "https://github.com/PyLadiesSP",
    },
    {
      name: "PyLadies Manaus",
      desc: "Comunidade Python feminina da Amazônia que promove aprendizado e empoderamento de mulheres no Norte do país.",
      url: "https://pyladiesmanaus.github.io/",
    },
    {
      name: "PretaLab",
      desc: "Plataforma do Olabi que mapeia e conecta mulheres negras e indígenas que atuam ou querem atuar em tecnologia.",
      url: "https://www.pretalab.com/",
    },
    {
      name: "Manas Digitais",
      desc: "Comunidade paraense que leva atividades de computação a estudantes de escolas públicas na região de Belém.",
      url: "https://www.instagram.com/manasdigitais/",
    },
    {
      name: "WOMCY (Women in Cybersecurity LATAM)",
      desc: "Organização sem fins lucrativos dedicada a ampliar a presença feminina na cibersegurança na América Latina.",
      url: "https://womcy.org/pt/",
    },
    {
      name: "Programe como uma garota",
      desc: "Programa de capacitação, mentoria e workshops gratuitos para preparar mulheres para o mercado de tecnologia.",
      url: "https://programecomoumagarota.com/",
    },
    {
      name: "Mais Mulheres Tech",
      desc: "Plataforma da WoMakersCode com Microsoft que reúne cursos, certificações e mentorias gratuitas para mulheres.",
      url: "https://www.maismulheres.tech/",
    },
    {
      name: "Ser Mulher em Tech",
      desc: "Comunidade que promove conteúdo, eventos e programa de mentoria para mulheres em diferentes momentos da carreira.",
      url: "https://sermulheremtech.org.br/",
    },
    {
      name: "AnitaB.org",
  ...
  courses: [
    ...
    {
      name: "reprograma",
      desc: "Cursos intensivos e gratuitos de programação para mulheres em situação de vulnerabilidade social.",
      url: "https://reprograma.com.br/",
    },
    {
      name: "Laboratoria",
      desc: "Programa latino-americano que prepara mulheres para carreiras sustentáveis na economia digital.",
      url: "https://laboratoria.la/",
    },
    {
      name: "Eu Progra{amo} (PrograMaria)",
      desc: "Formação introdutória ao desenvolvimento web pensada para mulheres e pessoas não binárias iniciantes.",
      url: "https://www.programaria.org/",
    },
    {
      name: "Mais Mulheres Tech",
      desc: "Trilhas gratuitas em áreas como IA, nuvem e segurança, com certificações e maratonas para mulheres.",
      url: "https://www.maismulheres.tech/",
    },
    {
      name: "Santander Code Girls",
      desc: "Programa gratuito de programação para mulheres oferecido pelo Santander via Santander Open Academy.",
      url: "https://www.santanderopenacademy.com/pt_br/index.html",
    },
    {
      name: "Elas+ Tech (Ada)",
      desc: "Formação gratuita em Back-end, Front-end ou Dados, com mentorias, voltada a mulheres na plataforma Ada.",
      url: "https://ada.tech/oportunidades/elas-mais-tech",
    },
    {
      name: "PyLadies São Paulo",
      desc: "Cursos gratuitos de Python, do básico ao avançado, ministrados pela comunidade em São Paulo.",
      url: "https://github.com/PyLadiesSP",
    },
    {
      name: "Django Girls Workshops",
      desc: "Workshops gratuitos de um dia para a primeira experiência em programação com Python e Django.",
      url: "https://djangogirls.org/en/events/",
    },
    {
      name: "Programe como uma garota",
      desc: "Formação técnica gratuita com mentoria e workshops para mulheres ingressarem na área de tecnologia.",
      url: "https://programecomoumagarota.com/",
    },
    {
      name: "Generation Brasil",
      desc: "ONG global que oferece bootcamps gratuitos de tecnologia, com turmas e projetos voltados a mulheres.",
  ...
  mentorship: [
    ...
    {
      name: "Ser Mulher em Tech - Programa de Mentoria",
      desc: "Mentoria estruturada que apoia mulheres em momentos distintos da jornada profissional em tecnologia.",
      url: "https://sermulheremtech.org.br/programadementoria/",
    },
    {
      name: "Mentoria Tech (Mulheres Positivas)",
      desc: "Programa gratuito de desenvolvimento para estudantes e recém-formadas em cursos de tecnologia.",
      url: "https://www.mulherespositivas.com.br/",
    },
    {
      name: "Elas+ Tech (Ada)",
      desc: "Mentorias personalizadas de carreira integradas à formação técnica gratuita para mulheres.",
      url: "https://ada.tech/oportunidades/elas-mais-tech",
    },
    {
      name: "Mais Mulheres Tech",
      desc: "Mentorias de carreira combinadas a cursos e certificações na plataforma da WoMakersCode com Microsoft.",
      url: "https://www.maismulheres.tech/",
    },
    {
      name: "PyLadies Brasil",
      desc: "Rede de mentoria entre mulheres da comunidade Python espalhada por vários capítulos no país.",
      url: "https://brasil.pyladies.com/",
    },
    {
      name: "AnitaB.org",
      desc: "Programas de mentoria e desenvolvimento de liderança para mulheres em computação em âmbito global.",
      url: "https://anitab.org/",
    },
    {
      name: "Laboratoria",
      desc: "Acompanhamento e mentoria de empregabilidade para mulheres ao longo da transição para a área tech.",
      url: "https://laboratoria.la/",
    },
    {
      name: "PrograMaria",
      desc: "Trilhas com apoio e conexão com o mercado para mulheres que estão começando ou crescendo em tecnologia.",
      url: "https://www.programaria.org/",
    },
    {
      name: "Programe como uma garota",
      desc: "Mentoria contínua e gratuita que acompanha mulheres durante a capacitação em programação.",
      url: "https://programecomoumagarota.com/",
    },
    {
      name: "WOMCY (Women in Cybersecurity LATAM)",
      desc: "Mentorias e desenvolvimento de habilidades técnicas para mulheres que querem crescer em cibersegurança.",
      url: "https://womcy.org/pt/",
    },
  ],
...
// Dicionario extraido para shared/glossaryData.ts (client e servidor leem a
// mesma fonte). Re-export mantem os imports existentes funcionando.
export { dictionaryTerms, type DictionaryTerm } from "@shared/glossaryData";
...
export const AREA_ACCENT: Record<string, string> = {
  ...
  "Ciência de Dados": "#b45309",
  "Análise de Dados / BI": "#a16207",
  "Engenharia de Dados": "#854d0e",
  "Banco de Dados / DBA": "#92400e",
  "Bioinformática": "#047857",
  "UX/UI Design": "#db2777",
  "Especialista em Acessibilidade (a11y)": "#9d174d",
  "Inteligência Artificial": "#6d28d9",
  "Visão Computacional": "#7e22ce",
  "Processamento de Linguagem Natural (PLN)": "#86198f",
  "MLOps": "#581c87",
  "Produto Digital": "#c026d3",
  "Gestão de Projetos Tech": "#4338ca",
  "Agilidade e Scrum Master": "#3730a3",
  "DevRel / Developer Advocate": "#164e63",
  "Technical Writer": "#475569",
  "Localização / i18n": "#57534e",
  "Cibersegurança": "#166534",
  "Perícia Digital / Forense": "#14532d",
  "Cloud Computing": "#0369a1",
  "DevOps": "#0e7490",
  "SRE (Site Reliability Engineering)": "#155e75",
  "Suporte e Infraestrutura / Redes": "#0c4a6e",
  "Suporte e Helpdesk": "#075985",
  "Engenharia de Plataforma": "#1d4ed8",
  "FinOps": "#065f46",
  ...
  "Mainframe": "#334155",
  "Computação Quântica": "#6b21a8",
  "Começar do Zero em TI": "#0f766e",
};

export function getAreaAccent(nome: string): string {
  return AREA_ACCENT[nome] ?? "#52525b";
}
