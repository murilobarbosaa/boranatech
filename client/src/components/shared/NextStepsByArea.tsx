  ...
  if (isGeneral) {
    ...
    return (
      <div className="card-brutal rounded-2xl border-slate-950 bg-violet-50 p-6">
        ...
        <Link
          href="/quiz-carreira"
          className="mt-4 inline-flex items-center gap-2 rounded-full border-2 border-slate-950 bg-[#FFB800] px-5 py-2.5 font-display text-sm font-black text-slate-950 shadow-[3px_3px_0_var(--bnt-shadow)] transition-transform hover:-translate-y-px"
        >
