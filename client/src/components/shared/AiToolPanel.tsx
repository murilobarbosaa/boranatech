...
> = {
  violet: {
    ...
    buttonEyebrow: "text-amber-100",
    inputFocus: "focus:ring-violet-200",
    resultBg: "bg-violet-50",
    skeletonBg: "bg-violet-100",
  },
  emerald: {
    ...
    buttonText: "text-white",
    buttonEyebrow: "text-amber-100",
    inputFocus: "focus:ring-emerald-200",
    resultBg: "bg-emerald-50",
    skeletonBg: "bg-emerald-100",
  },
  blue: {
    ...
    buttonText: "text-white",
    buttonEyebrow: "text-amber-100",
    inputFocus: "focus:ring-blue-200",
    resultBg: "bg-blue-50",
  ...
  sky: {
    ...
    buttonText: "text-white",
    buttonEyebrow: "text-amber-100",
    inputFocus: "focus:ring-sky-200",
    resultBg: "bg-sky-50",
    skeletonBg: "bg-sky-100",
  },
  cyan: {
    ...
    buttonText: "text-white",
    buttonEyebrow: "text-amber-100",
    inputFocus: "focus:ring-cyan-200",
    resultBg: "bg-cyan-50",
    skeletonBg: "bg-cyan-100",
  },
  fuchsia: {
    ...
    buttonText: "text-white",
    buttonEyebrow: "text-amber-100",
    inputFocus: "focus:ring-fuchsia-200",
    resultBg: "bg-fuchsia-50",
    skeletonBg: "bg-fuchsia-100",
  },
  orange: {
    ...
    buttonText: "text-white",
    buttonEyebrow: "text-amber-100",
    inputFocus: "focus:ring-orange-200",
    resultBg: "bg-orange-50",
    skeletonBg: "bg-orange-100",
  },
  rose: {
    ...
    buttonText: "text-white",
    buttonEyebrow: "text-amber-100",
    inputFocus: "focus:ring-rose-200",
    resultBg: "bg-rose-50",
    skeletonBg: "bg-rose-100",
  },
  teal: {
    ...
    buttonText: "text-white",
    buttonEyebrow: "text-amber-100",
    inputFocus: "focus:ring-teal-200",
    resultBg: "bg-teal-50",
    ...
    <div className="card-brutal rounded-2xl bg-white p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          ...
          <span>
            <span
              className={`block text-[10px] font-black uppercase tracking-wide ${a.buttonEyebrow}`}
            >
              executar com IA
            </span>
            <span className="block font-display font-black">
              {loading ? "Analisando..." : buttonLabel}
            </span>
          </span>
        </button>
      </form>
      ...
      {(result || error || loading) && (
        <div
          className={`mt-6 rounded-2xl border-2 border-slate-900 ${a.resultBg} p-5`}
        >
          {loading && (
            <div className={`h-24 animate-pulse rounded-xl ${a.skeletonBg}`} />
          )}
          {error && <p className="text-sm font-bold text-red-700">{error}</p>}
          {result && (
            <pre className="whitespace-pre-wrap font-body text-sm leading-relaxed text-slate-800">
              {result}
            </pre>
          )}
        </div>
