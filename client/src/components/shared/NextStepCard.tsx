...
export function NextStepCard({ proximoPasso }: { proximoPasso?: string }) {
  ...
  return (
    <div className="card-brutal rounded-2xl border-slate-950 bg-amber-100 p-6">
      ...
      <span className="inline-flex items-center gap-1.5 rounded-full border-2 border-slate-950 bg-[var(--brand-yellow)] px-3 py-1 text-xs font-black uppercase tracking-[0.15em] text-ink-on-accent shadow-[3px_3px_0_var(--bnt-shadow)]">
