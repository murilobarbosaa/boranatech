...
const ACCENT: Record<
  PageHeroAccent,
  { container: string; eyebrow: string; focusOutline: string }
> = {
  violet: {
    container: "bg-violet-100",
    eyebrow: "bg-violet-300",
    focusOutline: "focus-visible:outline-violet-700",
  },
  emerald: {
    container: "bg-emerald-100",
    eyebrow: "bg-emerald-300",
    focusOutline: "focus-visible:outline-emerald-700",
  },
  blue: {
    container: "bg-blue-100",
    eyebrow: "bg-blue-300",
    focusOutline: "focus-visible:outline-blue-700",
  },
  amber: {
    container: "bg-amber-100",
    eyebrow: "bg-amber-300",
    focusOutline: "focus-visible:outline-amber-700",
  },
  sky: {
    container: "bg-sky-100",
    eyebrow: "bg-sky-300",
    focusOutline: "focus-visible:outline-sky-700",
  },
  cyan: {
    container: "bg-cyan-100",
    eyebrow: "bg-cyan-300",
    focusOutline: "focus-visible:outline-cyan-700",
  },
  fuchsia: {
    container: "bg-fuchsia-100",
    eyebrow: "bg-fuchsia-300",
    focusOutline: "focus-visible:outline-fuchsia-700",
  },
  orange: {
    container: "bg-orange-100",
    eyebrow: "bg-orange-300",
    focusOutline: "focus-visible:outline-orange-700",
  },
  rose: {
    container: "bg-rose-100",
    eyebrow: "bg-rose-300",
    focusOutline: "focus-visible:outline-rose-700",
  },
  teal: {
    container: "bg-teal-100",
    eyebrow: "bg-teal-300",
    focusOutline: "focus-visible:outline-teal-700",
  },
};
  ...
  return (
    <>
      ...
      <span className="min-w-0">
        <span
          className={`mb-1 inline-flex rounded-full border border-slate-950 px-2 py-0.5 text-[10px] font-black uppercase tracking-wide text-slate-950 ${a.eyebrow}`}
        >
          recurso com IA
        </span>
        <span className="block font-display text-sm font-black leading-tight md:text-base">
          {children}
        </span>
        {description && (
...
export function AiCtaLink({
  ...
  return (
    <Link href={href} className={aiCtaClasses(accent, className)}>
      <AiCtaContent description={description} accent={accent}>
        {children}
      </AiCtaContent>
    </Link>
  );
...
export function AiCtaButton({
  ...
  return (
    <button
      type={type}
      onClick={onClick}
      className={aiCtaClasses(accent, className)}
