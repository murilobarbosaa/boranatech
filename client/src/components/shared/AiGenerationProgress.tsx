      ...
      <div className="mt-4 flex flex-wrap gap-3">
        {state.phase === "error" && state.slug && onResume ? (
          <button
            ...
            className="inline-flex items-center gap-2 rounded-[11px] border-[2.5px] border-slate-900 bg-[var(--brand-yellow)] px-4 py-2.5 text-sm font-black text-ink-on-accent shadow-[3px_3px_0_var(--bnt-shadow)] transition-all hover:-translate-y-px hover:shadow-[4px_4px_0_var(--bnt-shadow)]"
          >
