    ...
    return (
      <div className="card-brutal rounded-2xl bg-white p-8 text-center">
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            href="/cadastro"
            className="bnt-pressable inline-flex items-center gap-2 rounded-full border-2 border-slate-900 bg-[#FFB800] px-6 py-3 text-sm font-black text-slate-950 shadow-[3px_3px_0_var(--bnt-shadow)]"
          >
            Criar conta grátis
    ...
    <div className="card-brutal rounded-2xl bg-white p-6 sm:p-8">
      ...
      <div className="mt-6 flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="bnt-pressable inline-flex items-center gap-2 rounded-full border-2 border-slate-900 bg-[#FFB800] px-6 py-2 text-sm font-black text-slate-950 shadow-[3px_3px_0_var(--bnt-shadow)] disabled:cursor-not-allowed disabled:opacity-40"
        >
