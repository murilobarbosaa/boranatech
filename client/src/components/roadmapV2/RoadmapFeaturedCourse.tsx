        ...
        <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:items-start sm:gap-4 sm:text-left">
          ...
          <div className="min-w-0 flex-1">
            ...
            <a
              ...
              className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-[10px] border-[2.5px] border-slate-900 bg-[#FFB800] px-3 py-2 text-xs font-black text-slate-950 shadow-[3px_3px_0_var(--bnt-shadow)] transition-all hover:-translate-x-px hover:-translate-y-px hover:shadow-[4px_4px_0_var(--bnt-shadow)]"
            >
              Acessar
