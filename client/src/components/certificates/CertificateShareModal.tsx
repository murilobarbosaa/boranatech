          ...
          <div>
            ...
            <div className="mt-2 flex gap-2">
              ...
              <button
                ...
                className="inline-flex shrink-0 items-center gap-1.5 rounded-[10px] border-[2.5px] border-slate-950 bg-[#FFB800] px-3 py-2 text-sm font-black text-slate-950 shadow-[3px_3px_0_var(--bnt-shadow)] transition-all hover:-translate-y-px"
              >
                {copied === "link" ? (
