      ...
      <DialogContent className="gap-4 rounded-xl border-2 border-slate-950 bg-white p-6 shadow-[6px_6px_0_var(--bnt-shadow)] sm:max-w-md">
        ...
        <DialogFooter className="gap-3 sm:flex-row">
          <Button
            type="button"
            onClick={onEntrar}
            className="w-full sm:w-auto sm:flex-1 sm:min-w-0 rounded-full border-2 border-slate-950 bg-[#FFB800] font-black text-slate-950 shadow-[3px_3px_0_var(--bnt-shadow)] hover:bg-[#FFB800]"
          >
