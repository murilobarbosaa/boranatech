  ...
  return (
    ...
    >
      <div className="mb-3 flex flex-wrap items-center gap-2">
        {highlight ? (
          <span className="inline-flex items-center gap-1 rounded-full border-2 border-slate-950 bg-[var(--brand-yellow)] px-2 py-0.5 text-xs font-black text-slate-950">
