      ...
      >
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          <button
            ...
            onClick={onClose}
            disabled={isLoading}
            className="flex-1 rounded-full border-2 border-[#1a1a1a] bg-white px-5 py-3 font-display font-black text-slate-700 shadow-[3px_3px_0_var(--bnt-shadow)] disabled:opacity-60"
          >
            Cancelar
          </button>
          <button
