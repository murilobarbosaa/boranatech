      ...
      {open && (
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="relative w-full max-w-md rounded-3xl border-2 border-[#1a1a1a] bg-white p-6 md:p-8 shadow-[4px_4px_0_var(--bnt-shadow)]"
          ...
          >
            ...
            <div className="flex flex-col gap-2 sm:flex-row-reverse">
              <button
                ...
                className="inline-flex flex-1 items-center justify-center gap-2 rounded-full border-2 border-[#1a1a1a] bg-rose-500 px-5 py-3 font-display font-black uppercase tracking-wider text-sm text-white shadow-[3px_3px_0_var(--bnt-shadow)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[5px_5px_0_var(--bnt-shadow)]"
              >
                Sim, reiniciar
              </button>
              <button
