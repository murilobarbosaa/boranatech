...
export const BOTAO_CONFIRMAR =
  "bnt-pressable inline-flex items-center rounded-full border-2 border-slate-900 bg-emerald-300 px-4 py-1.5 text-xs font-black uppercase text-slate-950 shadow-[2px_2px_0_var(--bnt-shadow)] disabled:cursor-not-allowed disabled:opacity-50";
