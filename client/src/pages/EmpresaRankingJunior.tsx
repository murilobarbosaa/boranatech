...
export default function EmpresaRankingJunior() {
  return (
    <Layout>
      <PageHero
        title="Ranking de empresas para carreira inicial"
        subtitle="Empresas com mais oportunidades simuladas para estágio, trainee e júnior."
        accent="blue"
      />
          ...
          <table className="w-full min-w-[680px] text-sm">
            <thead className="bg-violet-700 text-white">
              <tr>
                ...
                <th className="p-4 text-left">Vagas iniciais abertas</th>
                <th className="p-4 text-left">Áreas que mais contrata</th>
              </tr>
            </thead>
            <tbody>
