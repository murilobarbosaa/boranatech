...
const resumeSections = [
  {
    ...
    desc: "Mostra área, nível, tecnologias principais e objetivo com clareza.",
  },
  {
    title: "Projetos",
    desc: "Explica problema, tecnologias, sua contribuição e link para código ou demo.",
  },
  {
    title: "Experiências",
    desc: "Valoriza estágio, freelas, voluntariado, suporte, estudos e transição de carreira.",
  },
  {
    title: "Palavras-chave",
    desc: "Ajusta termos que recrutadores e ATS procuram na vaga.",
  },
];
            ...
            <div className="card-brutal rounded-2xl bg-white p-6 lg:col-span-2">
              <div className="mb-5 flex items-start gap-3">
                ...
                <div>
                  <h2 className="font-display text-2xl font-black text-slate-950">
                    O que a IA vai revisar
                  </h2>
                  <p className="mt-1 text-sm text-slate-600">
                    A análise olha clareza, compatibilidade com vaga,
                    palavras-chave, ordem das seções e força dos projetos.
                  </p>
                </div>
              </div>
              <div className="grid gap-3 md:grid-cols-2">
                {resumeSections.map((section) => (
                  <div
                    key={section.title}
                    className="rounded-2xl border-2 border-violet-100 bg-violet-50 p-4"
                  >
              ...
              fields={[
                {
                  ...
                  type: "textarea",
                  placeholder:
                    "Cole aqui o texto do seu currículo, incluindo projetos, experiências, formação, habilidades e links.",
                },
                {
                  name: "job",
                  label: "Descrição da vaga alvo",
                  type: "textarea",
                  placeholder:
                    "Opcional: cole a vaga para receber análise de compatibilidade e palavras-chave faltantes.",
                },
                {
                  name: "area",
                  label: "Área desejada",
