            ...
            <div className="card-brutal mx-auto max-w-lg rounded-3xl bg-white p-8">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full border-2 border-slate-900 bg-[#FFB800] px-4 py-2 text-sm font-black text-slate-950 shadow-[3px_3px_0_var(--bnt-shadow)]"
                >
                  Solicitar novo link
                </Link>
              </div>
