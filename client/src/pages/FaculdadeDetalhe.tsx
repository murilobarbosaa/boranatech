...
const courseDetails: Record<string, CourseDetail> = {
  ...
  [slugifyCourse("Jogos Digitais")]: {
    ...
    careerOptions: ["Programador(a) de Jogos", "Game Designer Júnior", "Desenvolvedor(a) Indie", "Level Designer", "Desenvolvedor(a) de Gameplay"],
    salaryAreas: ["Front-end", "Mobile"],
    coreContents: ["Lógica e programação (C#)", "Game engines (Unity)", "Design de jogos e narrativa", "Arte e modelagem 2D/3D", "Física e matemática para games", "Produção e publicação de jogos"],
    practicalProjects: ["Jogo 2D completo em Unity", "Protótipo de mecânica de gameplay", "Game jam com entrega em 48 horas", "Jogo mobile simples publicado"],
    technologies: ["C#", "Unity", "C++", "Unreal Engine", "Godot", "Git"],
    firstJobs: ["Estágio em Desenvolvimento de Jogos", "Programador(a) de Jogos Júnior", "Game Designer Júnior", "QA de Jogos", "Desenvolvedor(a) Indie"],
    roadmap: ["Aprender lógica e C#", "Fazer um jogo simples na Unity", "Estudar game design e level design", "Participar de game jams", "Publicar um jogo e montar portfólio (itch.io, GitHub)"],
    marketContext:
  ...
  [slugifyCourse("Design de Games")]: {
    ...
    careerOptions: ["Game Designer", "Programador(a) de Jogos", "Artista Técnico", "Produtor(a) de Jogos", "Level Designer"],
    salaryAreas: ["UX/UI", "Front-end"],
    coreContents: ["Game design e narrativa", "Programação para jogos", "Arte digital e modelagem", "UX aplicado a games", "Produção e pipeline", "Teoria e história dos jogos"],
    practicalProjects: ["Documento de design de um jogo (GDD)", "Protótipo jogável", "Jogo em equipe multidisciplinar", "Estudo de narrativa interativa"],
    technologies: ["C#", "Unity", "Unreal Engine", "Godot", "Figma", "Git"],
    firstJobs: ["Estágio em Game Design", "Game Designer Júnior", "Assistente de Produção", "QA de Jogos", "Level Designer Júnior"],
    roadmap: ["Estudar fundamentos de game design", "Aprender uma engine (Unity ou Unreal)", "Criar protótipos jogáveis", "Trabalhar em projetos de equipe", "Montar portfólio com GDDs e jogos publicados"],
    marketContext:
  ...
  [slugifyCourse("Engenharia da Computação")]: {
    ...
    careerOptions: ["Engenheiro(a) de Software", "Engenheiro(a) de Sistemas Embarcados", "Engenheiro(a) de Hardware", "Desenvolvedor(a) Back-end", "Engenheiro(a) de Firmware"],
    salaryAreas: ["Back-end", "DevOps"],
    coreContents: ["Algoritmos e estruturas de dados", "Eletrônica e circuitos", "Sistemas embarcados", "Arquitetura de computadores", "Redes de computadores", "Cálculo e física"],
    practicalProjects: ["Sistema embarcado com microcontrolador", "Projeto de circuito com sensores", "Aplicação com comunicação hardware e software", "Algoritmo otimizado para recurso limitado"],
    technologies: ["C", "C++", "Python", "Arduino", "Linux", "Git"],
    firstJobs: ["Estágio em Engenharia", "Trainee em Tecnologia", "Desenvolvedor(a) Júnior", "Engenheiro(a) de Sistemas Embarcados Júnior", "Analista de Hardware Júnior"],
    roadmap: ["Reforçar matemática, física e lógica", "Aprender C e C++", "Estudar eletrônica e microcontroladores", "Construir projetos que unam hardware e software", "Escolher entre trilha de software, embarcados ou hardware"],
    marketContext:
  ...
  [slugifyCourse("Redes de Computadores")]: {
    ...
    careerOptions: ["Analista de Redes", "Administrador(a) de Sistemas", "Suporte de Infraestrutura", "Analista de Cloud", "Analista de Segurança Júnior"],
    salaryAreas: ["DevOps", "Cloud"],
    coreContents: ["Protocolos e modelo TCP/IP", "Administração de servidores", "Sistemas operacionais (Linux)", "Segurança de redes", "Cloud e virtualização", "Monitoramento e suporte"],
    practicalProjects: ["Configurar uma rede local com sub-redes", "Montar um servidor Linux com serviços", "Laboratório de roteamento e firewall", "Migrar um serviço para a nuvem"],
    technologies: ["Linux", "Docker", "AWS", "Ansible", "Prometheus", "Git"],
    firstJobs: ["Estágio em Infraestrutura", "Analista de Redes Júnior", "Administrador(a) de Sistemas Júnior", "Suporte Técnico", "Analista de Cloud Júnior"],
    roadmap: ["Aprender fundamentos de redes (TCP/IP)", "Dominar Linux e linha de comando", "Praticar configuração de servidores", "Tirar certificações (Cisco, AWS)", "Evoluir para cloud ou DevOps"],
    marketContext:
  ...
  [slugifyCourse("Segurança da Informação")]: {
    ...
    careerOptions: ["Analista de Segurança", "Analista SOC", "Pentester Júnior", "Analista de Conformidade", "Analista de Resposta a Incidentes"],
    salaryAreas: ["DevOps", "Back-end"],
    coreContents: ["Fundamentos de redes", "Criptografia", "Análise de vulnerabilidades", "Resposta a incidentes", "Segurança de aplicações", "Conformidade e boas práticas"],
    practicalProjects: ["Laboratório de pentest em ambiente controlado", "Análise de vulnerabilidades de uma aplicação", "Hardening de um servidor Linux", "Writeup de máquinas (TryHackMe, Hack The Box)"],
    technologies: ["Linux", "Python", "Docker", "Git"],
    firstJobs: ["Estágio em Segurança", "Analista SOC Júnior", "Analista de Segurança Júnior", "Pentester Júnior", "Analista de Conformidade Júnior"],
    roadmap: ["Aprender redes e Linux", "Estudar fundamentos de segurança e criptografia", "Praticar em laboratórios (TryHackMe, Hack The Box)", "Documentar writeups e estudos", "Mirar certificações de segurança"],
    marketContext:
  ...
  [slugifyCourse("Ciência de Dados")]: {
    ...
    careerOptions: ["Analista de Dados", "Cientista de Dados Júnior", "Analista de BI", "Engenheiro(a) de Dados Júnior", "Analista de Analytics"],
    salaryAreas: ["Dados", "Back-end"],
    coreContents: ["Estatística aplicada", "Python e R para dados", "SQL e banco de dados", "Visualização de dados", "Introdução a machine learning", "Storytelling com dados"],
    practicalProjects: ["Análise exploratória de um dataset real", "Dashboard de indicadores", "Modelo de previsão simples", "Relatório com storytelling de dados"],
    technologies: ["Python", "R", "SQL", "Pandas", "NumPy", "Power BI", "Git"],
    firstJobs: ["Estágio em Dados", "Analista de Dados Júnior", "Analista de BI Júnior", "Cientista de Dados Júnior", "Engenheiro(a) de Dados Júnior"],
    roadmap: ["Aprender Python e SQL", "Estudar estatística aplicada", "Criar análises e dashboards", "Praticar no Kaggle", "Publicar projetos de dados no GitHub"],
    marketContext:
  ...
  [slugifyCourse("Gestão da Tecnologia da Informação")]: {
    ...
    careerOptions: ["Gestor(a) de TI", "Analista de Projetos", "Product Owner", "Consultor(a) de TI", "Analista de Processos"],
    salaryAreas: ["Produto", "Dados"],
    coreContents: ["Governança de TI", "Gestão de projetos", "Processos e ITIL", "Infraestrutura e sistemas", "Fundamentos de desenvolvimento", "Gestão e negócios"],
    practicalProjects: ["Plano de projeto de TI", "Mapeamento de processos", "Análise de viabilidade de um sistema", "Painel de indicadores de TI"],
    technologies: ["SQL", "Power BI", "Jira", "Trello", "Notion", "Git"],
    firstJobs: ["Estágio em TI", "Analista de Projetos Júnior", "Assistente de PMO", "Product Owner Júnior", "Consultor(a) de TI Júnior"],
    roadmap: ["Entender fundamentos de TI e desenvolvimento", "Aprender gestão de projetos e processos", "Estudar metodologias ágeis", "Praticar com ferramentas de gestão (Jira, Trello)", "Montar cases de projetos e processos"],
    marketContext:
  ...
  [slugifyCourse("Sistemas para Internet")]: {
    ...
    careerOptions: ["Desenvolvedor(a) Web", "Desenvolvedor(a) Front-end", "Desenvolvedor(a) Back-end", "Desenvolvedor(a) Full Stack", "Analista de Sistemas"],
    salaryAreas: ["Front-end", "Back-end"],
    coreContents: ["HTML, CSS e JavaScript", "Desenvolvimento back-end", "Banco de dados", "Design de interfaces", "APIs e integração", "Hospedagem e deploy"],
    practicalProjects: ["Site responsivo completo", "API REST com banco de dados", "Aplicação full stack simples", "Loja ou blog publicado online"],
    technologies: ["HTML", "CSS", "JavaScript", "TypeScript", "React", "Node.js", "PostgreSQL", "Git"],
    firstJobs: ["Estágio em Desenvolvimento Web", "Desenvolvedor(a) Front-end Júnior", "Desenvolvedor(a) Back-end Júnior", "Desenvolvedor(a) Full Stack Júnior", "Analista de Sistemas Júnior"],
    roadmap: ["Aprender HTML, CSS e JavaScript", "Praticar Git e versionamento", "Construir um back-end com banco de dados", "Criar uma aplicação full stack", "Publicar 2 projetos e aplicar para vagas júnior"],
    marketContext:
