          ...
          <div className="container space-y-6">
            ...
            >
              <div className="mb-4 flex items-center gap-3">
                <span className="grid h-8 w-8 shrink-0 place-items-center rounded-full border-2 border-slate-900 bg-amber-300 font-display text-sm font-black text-ink-on-accent shadow-[2px_2px_0_var(--bnt-shadow)]">
                  1
                </span>
                <div>
