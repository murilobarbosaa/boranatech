...
function CommandSidebar({
  ...
  return (
    <aside
      ...
      className="bnt-keep-colors self-start overflow-hidden rounded-2xl border-2 border-slate-950 bg-slate-900 shadow-[5px_5px_0_var(--bnt-shadow)] md:shadow-[8px_8px_0_var(--bnt-shadow)]"
    >
...
function CommandChipsMobile({
  ...
  return (
    <aside
      ...
      className="bnt-keep-colors rounded-2xl border-2 border-slate-950 bg-slate-900 p-3 shadow-[5px_5px_0_var(--bnt-shadow)]"
    >
...
const TerminalCard = forwardRef<TerminalCardHandle, TerminalCardProps>(
  function TerminalCard(
    ...
    return (
      <div className="bnt-keep-colors flex h-full flex-col overflow-hidden rounded-2xl border-2 border-slate-950 bg-slate-950 shadow-[5px_5px_0_var(--bnt-shadow)] md:shadow-[8px_8px_0_var(--bnt-shadow)]">
