          ...
          <Link href="/planos">
            ...
            >
              <div className="flex flex-col items-center gap-6 text-center md:flex-row md:gap-8 md:text-left">
                ...
                <div className="pro-glare relative overflow-hidden inline-flex shrink-0 items-center gap-2 rounded-xl border-2 border-slate-900 bg-[var(--brand-yellow)] px-6 py-3 font-display font-black text-ink-on-accent shadow-[4px_4px_0_var(--bnt-shadow)] transition-all group-hover:shadow-[6px_6px_0_var(--bnt-shadow)]">
      ...
      <article className="relative rounded-3xl border-2 border-slate-950 bg-white p-6 md:p-8 shadow-[8px_8px_0_var(--bnt-shadow)]">
        ...
        <div className="mt-6 pt-6 border-t-2 border-slate-200 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link href="/entrevistas">
            <button className="pro-glare relative overflow-hidden group inline-flex items-center gap-2 rounded-xl border-2 border-slate-950 bg-amber-300 px-5 py-2.5 font-display font-black text-ink-on-accent shadow-[3px_3px_0_var(--bnt-shadow)] transition-all hover:shadow-[5px_5px_0_var(--bnt-shadow)] hover:-translate-y-0.5">
              <ProStarIcon />
