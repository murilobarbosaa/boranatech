    ...
    <Layout>
      ...
      <section className={cn(ac.contentBg, "py-12")}>
        ...
        {!isPro ? <ProGate description="A IA analisa seu perfil GitHub público e indica se ele está pronto para vagas de estágio, trainee, júnior ou pleno." /> : (
          <AiToolPanel endpoint="github-review" title="Analisar GitHub" description="Cole a URL do seu perfil ou repositório público." fields={[{ name: "githubUrl", label: "URL do GitHub", placeholder: "https://github.com/seuusuario" }, { name: "target", label: "Vaga ou nível alvo", placeholder: "Front-end Trainee/Júnior" }]} />
        )}
        </div>
      </section>
    </Layout>
