    ...
    <Layout>
      ...
      <section className={cn(ac.contentBg, "py-12")}>
        <div className="container">
          {!isPro ? (
            <ProGate description="A IA analisa seu perfil GitHub público e indica se ele está pronto para vagas de estágio, trainee, júnior ou pleno." />
          ) : (
            <AiToolPanel
              endpoint="github-review"
              accent="blue"
              title="Analisar GitHub"
              description="Cole a URL do seu perfil ou repositório público."
              fields={[
                {
                  name: "githubUrl",
                  label: "URL do GitHub",
                ...
                {
                  name: "target",
                  label: "Vaga ou nível alvo",
                  placeholder: "Front-end Trainee/Júnior",
                },
              ]}
            />
          )}
