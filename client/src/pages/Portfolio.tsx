    ...
    <Layout>
      ...
      <section className={cn(ac.contentBg, "py-12")}>
        <div className="container space-y-10">
            ...
            {portfolioGuides.map(([area, quantity, project, avoid]) => (
              ...
              >
                <div className="mt-4 space-y-2 text-sm text-slate-700">
                  ...
                  <p>
                    <strong>Exemplo real:</strong> GitHub/Behance de
              ...
              {portfolioChecklist.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={
                        isChecked ? "text-slate-950" : "text-slate-700"
                      }
                    >
                      {item.label}
                    </span>
          ...
          <div
            className={cn(
              "card-brutal rounded-2xl p-6 text-white",
              ac.tableBanner,
            )}
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                >
                  ...
                  README é o texto que explica seu projeto no GitHub: o que ele
                  faz, quais tecnologias usou, como acessar, como rodar e o que
                  você aprendeu.
                </p>
              </div>
            </div>
            <div className="mt-5 grid gap-3 md:grid-cols-3">
              <div className="rounded-2xl bg-white/10 p-4">
                ...
                <p className={cn("mt-1 text-xs", ac.tableBannerMuted)}>
                  Para recrutadores entenderem seu projeto sem precisar
              ...
              <div className="rounded-2xl bg-white/10 p-4">
                ...
                <p className={cn("mt-1 text-xs", ac.tableBannerMuted)}>
                  Escolha o modelo parecido com seu projeto, copie e substitua
