      ...
      <div className="relative z-10">
        <div className="mb-3 flex items-center gap-3">
          <motion.span
            ...
            className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border-2 border-slate-900 text-white shadow-[2px_2px_0_var(--bnt-shadow)]"
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        {areas.map((area, idx) => {
          ...
          return (
            <div
              key={area.area}
              className="flex flex-col rounded-2xl border-2 border-slate-300 bg-white p-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-900 hover:shadow-[3px_3px_0_var(--bnt-shadow)]"
            >
