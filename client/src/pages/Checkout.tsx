          ...
          <div className="mx-auto max-w-4xl text-center">
                            ...
                            <div className="relative flex flex-col items-center">
                              ...
                              <DialogClose asChild>
                                <button
                                  ...
                                  className="pro-glare bnt-pressable mt-7 flex w-full items-center justify-center gap-2 overflow-hidden rounded-2xl border-2 border-slate-950 bg-[#FFB800] px-8 py-3.5 font-display text-base font-black text-slate-950 shadow-[5px_5px_0_var(--bnt-shadow)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[7px_7px_0_var(--bnt-shadow)]"
                                >
                                  <ProStarIcon />
                                  Quero o Pro
            ...
            >
              <button
                ...
                className="pro-glare bnt-pressable group relative inline-flex items-center gap-2 overflow-hidden rounded-2xl border-2 border-slate-950 bg-[#FFB800] px-8 py-4 font-display text-base md:text-lg font-black text-slate-950 shadow-[5px_5px_0_var(--bnt-shadow)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[7px_7px_0_var(--bnt-shadow)]"
              >
                <ProStarIcon />
            ...
            {billingStatus === "on" ? (
              <>
                ...
                <button
                  ...
                  disabled={loading}
                  className="pro-glare bnt-pressable inline-flex items-center justify-center gap-2 overflow-hidden rounded-full border-2 border-slate-900 bg-[#FFB800] px-8 py-4 font-display font-black text-slate-950 shadow-[5px_5px_0_var(--bnt-shadow)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[7px_7px_0_var(--bnt-shadow)] disabled:opacity-60 disabled:hover:translate-y-0 disabled:hover:shadow-[5px_5px_0_var(--bnt-shadow)]"
                >
                  <Sparkles className="h-5 w-5" />
                  {loading
                    ? "Abrindo checkout..."
