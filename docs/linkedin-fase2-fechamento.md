...
| Tag vazada em campo de conversa                                                           | Campo de classe 1 reprovado por vazamento tem a TAG removida do texto entregue, e a violação continua registrada. É a única edição permitida em prosa, e não afrouxa a regra: a proibição protege conteúdo semântico, e a tag é artefato do nosso próprio prompt ecoado pelo modelo.                                | `removerVazamentoDeDelimitador`                  |
