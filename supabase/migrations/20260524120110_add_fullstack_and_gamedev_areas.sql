...
(
  ...
  '{"label":"Júnior R$ 2.700 a R$ 4.800, Pleno R$ 4.700 a R$ 8.300 (Glassdoor 2026)","difficulty":4}'::jsonb,
...
(
  ...
  'Pessoa apaixonada por jogos com paciência pra testes infinitos. Combina lógica de programação com sensibilidade pra experiência do jogador. Tolerante a ferramentas complexas, gosta de matemática (vetores, álgebra linear) e tem perfil colaborativo, pois game dev é trabalho em equipe multidisciplinar. Importante: o salário inicial é menor que outras áreas de dev, então paixão pela área conta muito.',
  ...
  '{"label":"Júnior R$ 2.100 a R$ 4.800, Sênior até R$ 9.300. Média BR R$ 3.300 (Glassdoor 2026)","difficulty":4}'::jsonb,
