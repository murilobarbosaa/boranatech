...
async function createCheckout(
  ...
  if (input.paymentMethod === "boleto") {
    ...
    const session = await getStripe().checkout.sessions.create({
      ...
      // cobranca de boleto entra no ledger sem dono, e foi assim que uma
      // assinante com Pro ativo apareceu na fila de pagamentos orfaos sem ter
      // problema nenhum: o dinheiro estava certo, o vinculo e que faltava.
      //
