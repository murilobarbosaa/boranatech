...
export const PLATFORM_ROUTES: PlatformRoute[] = [
  ...
  { route: "/empresas", tier: "free", label: "Empresas de tecnologia." },
  {
    route: "/salarios",
    tier: "free",
    label: "Dados de salarios em tecnologia.",
  },
  {
    route: "/entrevistas",
    tier: "pro",
    label: "Treino de entrevista com IA (area 100% Pro).",
  },
  // TODO(Ana): validar a copy das entradas de /vagas
  {
    route: "/vagas",
    tier: "pro",
    label: "Guia de freelance (secao na pagina de vagas).",
  },
  { route: "/portfolio", tier: "free", label: "Guia de portfolio." },
  {
    ...
    tier: "pro",
    label:
      "Plano de carreira por IA: rota com degraus, certificacoes e cronograma.",
  },
  {
    route: "/evolucao",
    tier: "free",
    label: "Trilhas de evolucao de carreira.",
  },
  {
    route: "/ingles",
    tier: "free",
    label: "Recursos de ingles para tecnologia.",
  },
  {
    route: "/ingles/onde-estudar",
    tier: "free",
    label: "Onde estudar ingles.",
  },
  { route: "/ingles/no-trabalho", tier: "free", label: "Ingles no trabalho." },
  {
    route: "/ingles/entrevista",
    tier: "free",
    label: "Ingles para entrevista.",
  },
  {
    route: "/ingles/vocabulario",
    tier: "free",
    label: "Vocabulario de ingles.",
  },
  ...
  { route: "/ia", tier: "free", label: "Guia de IA." },
  {
    route: "/mentorias",
    tier: "free",
    label: "Mentorias e ebooks de parceiros (em breve).",
  },
  {
    route: "/roadmaps",
    tier: "free",
    label: "Indice de roadmaps de aprendizado.",
  },
  { route: "/cursos", tier: "free", label: "Diretorio de cursos." },
  {
    route: "/plataformas",
    tier: "free",
    label: "Diretorio de plataformas de estudo.",
  },
  ...
  { route: "/eventos", tier: "free", label: "Eventos de tecnologia." },
  {
    route: "/projetos",
    tier: "free",
    label: "Projetos para praticar e portfolio.",
  },
  {
    route: "/vagas",
    tier: "pro",
    label:
      "Feed de vagas reais de estagio, trainee e junior, com busca e filtros (Pro); amostra gratis do feed.",
  },
  ...
  { route: "/mulheres", tier: "free", label: "Mulheres na tecnologia." },
  {
    route: "/dicionario",
    tier: "free",
    label: "Dicionario de termos de tecnologia.",
  },
  {
    route: "/comparador",
    tier: "pro",
    label:
      "Comparador: faculdades, cursos, plataformas, areas e tecnologias lado a lado.",
  },
  ...
  { route: "/perfil", tier: "free", label: "Perfil do usuario." },
  {
    ...
    tier: "free",
    label: "Favoritos salvos do usuario.",
  },
  {
    route: "/perfil/conquistas",
    tier: "free",
    label: "Conquistas do usuario.",
  },
  ...
  // Pagina de assinatura. Publica (qualquer um ve), e o destino dos CTAs do Pro.
  {
    route: "/planos",
    tier: "free",
    label: "Pagina de assinatura do Plano Pro.",
  },
  ...
  {
    route: "/quiz-carreira/resultado",
    tier: "free",
    label: "Resultado do quiz de carreira.",
  },
  {
    route: "/tecnologias/por-area",
    tier: "free",
    label: "Mapa de tecnologias por area.",
  },
  {
    route: "/tecnologias/ranking",
    tier: "free",
    label: "Ranking de tecnologias.",
  },
  {
    route: "/tecnologias/comparar",
    tier: "free",
    label: "Comparador de tecnologias.",
  },
  {
    route: "/tecnologias/jogos",
    tier: "free",
    label: "Jogos para aprender tecnologias.",
  },
  {
    route: "/empresas/ranking-junior",
    tier: "free",
    label: "Ranking de empresas para junior.",
  },
  {
    route: "/roadmaps/comecar-do-zero",
    tier: "free",
    label: "Trilha para comecar do zero.",
  },
  { route: "/roadmaps/linkedin", tier: "free", label: "Trilha de LinkedIn." },
  {
    route: "/carreiras",
    tier: "free",
    label: "Vagas de carreira (aba da pagina de vagas).",
  },
  {
    route: "/portifolio",
    tier: "free",
    label: "Aba de portfolio da pagina de vagas.",
  },
  {
    route: "/planos/sucesso",
    tier: "free",
    label: "Confirmacao de assinatura concluida.",
  },
  {
    route: "/checkout",
    tier: "free",
    label: "Checkout da assinatura do Plano Pro.",
  },
  ...
  { route: "/cadastro", tier: "free", label: "Pagina de criacao de conta." },
  {
    route: "/bem-vindo",
    tier: "free",
    label: "Boas-vindas apos criar a conta.",
  },
  {
    route: "/recuperar-senha",
    tier: "free",
    label: "Recuperacao de senha por email.",
  },
  {
    route: "/trocar-senha",
    tier: "free",
    label: "Troca de senha do usuario logado.",
  },
  {
    route: "/redefinir-senha",
    tier: "free",
    label: "Redefinicao de senha via link de email.",
  },
  ...
  // Rotas Pro: analise personalizada por IA (server/lib/aiTools.ts requiresPro).
  {
    ...
    tier: "pro",
    label: "Analise de curriculo por IA.",
  },
  {
    route: "/curriculo/gerar",
    tier: "pro",
    label: "Geracao de curriculo por IA.",
  },
  {
    route: "/linkedin/analisar",
    tier: "pro",
    label:
      "Analise de perfil de LinkedIn por IA: nota, checklist de recrutador e textos prontos para colar.",
  },
  {
    route: "/portfolio/analisar",
    tier: "pro",
    label:
      "Analise de portfolio por IA com base no GitHub (a analise de GitHub).",
  },
  // TODO(Ana): revisar o label do Roadmap com IA.
  {
    route: "/roadmaps/ia",
    tier: "pro",
    label: "Roadmap com IA: gera uma trilha de estudos sob medida.",
  },
];
...
export const PLATFORM_ROUTE_PATTERNS: PlatformRoutePattern[] = [
  {
    pattern: "/areas/:slug",
    tier: "free",
    label: "Detalhe de uma area de tecnologia.",
  },
  {
    pattern: "/areas/:parent/:subarea",
    tier: "free",
    label: "Detalhe de uma subarea de tecnologia.",
  },
  {
    pattern: "/tecnologias/:slug",
    tier: "free",
    label: "Detalhe de uma tecnologia.",
  },
  {
    pattern: "/empresas/:slug",
    tier: "free",
    label: "Detalhe de uma empresa de tecnologia.",
  },
  ...
  {
    pattern: "/roadmaps/ia/:slug",
    tier: "pro",
    label: "Um roadmap gerado por IA do proprio usuario.",
  },
  {
    pattern: "/roadmaps/:slug",
    tier: "free",
    label: "Trilha de aprendizado especifica.",
  },
  {
    pattern: "/faculdades/:slug",
    tier: "free",
    label: "Detalhe de uma faculdade.",
  },
];
