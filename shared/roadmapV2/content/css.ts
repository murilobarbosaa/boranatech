    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          content:
            "Imagem é a causa mais comum de página que rola de lado no celular: o arquivo tem 1200 pixels de largura, a tela tem 360, e a imagem simplesmente sai pela direita.\n\nA primeira regra resolve isso para o site inteiro:\n\n```css\nimg {\n  max-width: 100%;\n  height: auto;\n}\n```\n\n`max-width: 100%` impede a imagem de passar da largura do elemento que a contém, e `height: auto` recalcula a altura para a proporção não se perder. A segunda declaração importa quando o `<img>` traz o atributo `height`, como a trilha HTML do Zero recomenda: sem ela a largura encolhe, a altura fica onde estava e a imagem sai achatada.\n\nA segunda regra é para quando você precisa de um tamanho fixo, como numa galeria em que todos os cartões têm a mesma altura:\n\n```css\n.cartao img {\n  aspect-ratio: 16 / 9;\n  object-fit: cover;\n}\n```\n\n`object-fit: cover` preenche a área recortando o excesso, sem esticar. O valor `contain` faz o oposto: cabe a imagem inteira e sobra espaço.\n\nO `alt`, que a trilha HTML do Zero trata no passo Imagens com img e alt, continua sendo obrigação da marcação: nenhuma dessas regras substitui a descrição para quem não vê a imagem.\n\nVocê domina este passo quando nenhuma imagem sua estoura a largura da tela nem sai distorcida.",
          resources: [
            {
