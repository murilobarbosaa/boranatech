    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          description: "A essência do papel: servir o time, não comandá-lo.",
          content:
      ...
      children: [
        {
          ...
          description: "Organizar o trabalho e decidir o que fazer primeiro.",
          content:
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          resources: [
            {
              label: "Scrum.org: certificações profissionais (PSM, PSPO)",
