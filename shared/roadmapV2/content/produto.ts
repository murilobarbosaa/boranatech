  ...
  sections: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          resources: [
            {
              label: "Atlassian: agile (referência oficial)",
      ...
      children: [
        {
          ...
          description:
            "Por que o lançamento é um começo, não um fim.",
          content:
