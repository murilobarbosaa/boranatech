...
// de SQL e resources novos). Enquadramento de papel: o dado vira DECISAO de
// negocio (BI, metrica, dashboard), nao investigacao exploratoria.
      ...
      children: [
        {
          ...
          resources: [
            {
              label: "Microsoft Power Query (documentação oficial)",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          content:
            "Olhe pra trás um instante: você entrou nesta trilha decorando o primeiro `SELECT`, e agora extrai dados com JOIN e GROUP BY, limpa o que chega bagunçado, escolhe as métricas certas e monta um painel que alguém usa pra decidir. Este passo junta tudo numa entrega só, a que melhor prova o que você virou: um analista.\n\nA encomenda é o painel do projeto abaixo, um **dashboard financeiro executivo**: as poucas métricas que contam a saúde do negócio (receita, custo, margem, evolução no tempo), num painel limpo que um gestor lê em trinta segundos e sabe o que fazer. Percorra o fluxo que abriu a trilha: parta das perguntas que o gestor faria, extraia e prepare os dados, escolha os KPIs, e monte o painel com foco e hierarquia, o número que importa em destaque.\n\nMas o dashboard sozinho não fecha o projeto. Aplique o passo Storytelling com dados: acompanhe o painel de uma leitura curta que diga o que os números revelam e o que você recomenda. Painel sem narrativa é enfeite; com narrativa, é decisão.\n\nO critério de chegada é objetivo: o painel publicado (no portfólio ou no GitHub), respondendo a perguntas de negócio claras, e você explicando cada KPI e cada recomendação sem hesitar. É este projeto que vira a peça central do seu portfólio de analista.",
