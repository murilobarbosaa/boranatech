  ...
  sections: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          content:
            'Todo elemento HTML tem a mesma forma, e aprender essa forma uma vez resolve o resto da trilha.\n\n```html\n<a href="https://exemplo.com">Visite o exemplo</a>\n```\n\nA **tag de abertura** é `<a>`: o nome do elemento entre sinais de menor e maior. O **conteúdo** é o que vem depois dela, aqui o texto que aparece na tela. A **tag de fechamento** é `</a>`, igual à de abertura com uma barra antes do nome. E o **atributo** é o `href`, que fica dentro da tag de abertura, no formato nome igual valor, com o valor entre aspas duplas.\n\nCada elemento tem os seus atributos: `href` é do link, `src` é da imagem, `id` serve para qualquer um.\n\nAlguns elementos não têm conteúdo nem fechamento, porque não faria sentido: `<br>` é uma quebra de linha, `<img>` é uma imagem. São os elementos **vazios**. A barra no fim, como em `<br />`, é permitida pelo padrão e não muda nada; esta trilha escreve sem ela.\n\nElementos vivem dentro de elementos, e o fechamento segue a ordem inversa da abertura: o último aberto é o primeiro a fechar.\n\n```html\n<p>Leia <strong>com atenção</strong> antes.</p>\n```\n\nO `<strong>` abre depois do `<p>` e fecha antes dele. Quando um fechamento falta, ou sai fora de ordem, o navegador conserta em silêncio e a página parece certa; o passo Validar e inspecionar, na seção Acessibilidade e qualidade, mostra como enxergar isso.\n\nVocê domina este passo quando aponta, num elemento qualquer, onde estão a tag, o conteúdo e o atributo.',
          resources: [
            {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          content:
            'Duas informações da página viajam para fora dela.\n\n```html\n<title>Ana Souza | Desenvolvedora front-end</title>\n<meta name="description"\n      content="Portfólio de Ana Souza e contato.">\n```\n\nO `<title>` nomeia a aba do navegador, vira o texto do favorito e costuma ser o título azul do resultado de busca. Ele é obrigatório: uma página sem `<title>` aparece como Sem título em toda lista. Escreva um título curto o bastante para não ser cortado na aba nem no resultado de busca, do específico para o geral, como no exemplo.\n\nO `<meta name="description">` guarda o resumo. Buscadores costumam exibi-lo abaixo do título, e nem sempre: eles podem preferir um trecho do próprio conteúdo. Ainda assim vale escrever, em uma ou duas frases, dizendo o que a pessoa encontra ali.\n\nUm erro comum é repetir o mesmo título e a mesma descrição em todas as páginas do site. Cada página tem um assunto, e esses dois campos existem para dizer qual é.\n\nA trilha Front-end do Zero volta a esse assunto no passo SEO básico, com o resto do que buscadores leem.\n\nVocê domina este passo quando escreve título e descrição diferentes para duas páginas do mesmo site.',
          resources: [
            {
