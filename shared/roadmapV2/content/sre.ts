// TODO(Ana): revisao editorial do upgrade da fase 3c, lote 4 (fecho do projeto
// reescrito com enquadramento de SRE, fechos de criterio na espinha dorsal,
// conexoes nominais, blocos de codigo e resources novos). Enquadramento de
// papel: SRE MANTEM NO AR E MEDE (confiabilidade como numero: SLI, SLO, error
// budget, toil, resposta a incidente e aprendizado sem culpa). A espinha
// (SLI/SLO/error budget/toil/postmortem) ja estava em nivel de excelencia e
// nao foi reescrita, so recebeu fechos de criterio pontuais.
      ...
      children: [
        {
          ...
          content:
            "Olhe pra trás um instante: você entrou nesta trilha sabendo que confiabilidade é uma palavra vaga, e agora a mede com SLIs, define metas com SLOs, gerencia risco com error budget, enxerga o sistema pelos três pilares da observabilidade e responde a incidentes com postmortem sem culpa. Este passo junta tudo no artefato que melhor prova um SRE: uma stack que demonstra confiabilidade **medida**, não prometida.\n\nA encomenda é a stack do projeto abaixo: suba uma aplicação com Prometheus e Grafana coletando métricas, escolha um SLI que reflita a experiência do usuário (disponibilidade ou latência), declare um SLO explícito sobre ele e mostre o error budget correspondente no painel. Depois, o que separa o projeto de um dashboard bonito: configure um alerta que dispare por **sintoma** (a taxa de erros subindo), não por causa interna.\n\nPor fim, prove o ciclo completo: **simule um incidente** (derrube o serviço ou injete erros), deixe o alerta disparar, restaure, e escreva um **postmortem sem culpa** com a linha do tempo, o quanto de error budget foi gasto e as ações pra evitar a repetição.\n\nO critério de chegada é objetivo: o repositório no GitHub com a stack reproduzível, o SLO e o error budget visíveis, um alerta por sintoma que você viu disparar, e o postmortem do incidente simulado. É este projeto que prova que você não apenas opera, você **mede e gerencia** confiabilidade, o que define um SRE.",
