...
export const qa: RoadmapV2 = {
  ...
  sections: [
      ...
      children: [
        {
          ...
          resources: [
            {
              label: "ISTQB (organização internacional de certificação em testes)",
    ...
    },
    {
      ...
      title: "Teste de APIs",
      description:
        "Testar a camada por baixo da interface, onde os sistemas de fato trocam dados.",
      level: "intermediario",
      children: [
        {
          id: "apis.postman",
