// GENERATED FILE. Do not edit. Run pnpm gen:roadmap-meta
...
export const roadmapsMeta: RoadmapMeta[] = [
  {
    "slug": "frontend",
    "area": "frontend",
  ...
  },
  {
    ...
    "level": "Iniciante",
    "description": "Da lógica de servidor até publicar uma API com banco de dados. Conclua uma etapa pra liberar a próxima.",
    "languages": [
      {
        "id": "node",
        "label": "Node.js"
  ...
  },
  {
    ...
    "level": "Iniciante",
    "description": "Das bases de Linux e redes aos serviços de computação, identidade, containers e automação na nuvem. Escolha seu provedor e conclua uma etapa pra liberar a próxima.",
    "languages": [
      {
        "id": "aws",
        "label": "AWS"
  ...
  },
  {
    ...
    "level": "Iniciante",
    "description": "Da escolha da engine e da linguagem às mecânicas, física, game design e publicação do seu primeiro jogo. Escolha sua engine e conclua uma etapa pra liberar a próxima.",
    "languages": [
      {
        "id": "unity",
        "label": "Unity (C#)"
