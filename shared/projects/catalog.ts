...
export const projetos: ProjetoCatalogo[] = [
  ...
  // FRONTEND (15)
  { id: "portfolio-pessoal-html-css", nome: "Portfólio Pessoal Minimalista", areaSlug: "frontend" as string | null, nivel: "Iniciante", objetivo: "Construir uma página pessoal com biografia, habilidades e links de contato usando layouts flexíveis.", ferramentas: ["HTML5", "CSS3", "Google Fonts", "Visual Studio Code"], passosSimplificados: ["Monte a estrutura semântica do HTML com header, main, sections e footer.", "Crie variáveis CSS para cores, fontes e espaçamentos uniformes.", "Aplique Flexbox no menu e na seção de contato.", "Estilize botões e links com efeitos de transição.", "Adicione media queries para adaptar o layout a smartphones."], entregavel: "Página web de portfólio estática e responsiva.", comoPublicar: "GitHub Pages", sugestaoLinkedIn: "Construí meu primeiro portfólio pessoal responsivo com HTML5 e CSS3! Fixei conceitos de semântica e Flexbox.", proximoProjeto: "Calculadora Clássica com JavaScript" },
  { id: "calculadora-javascript", nome: "Calculadora Clássica", areaSlug: "frontend" as string | null, nivel: "Iniciante", objetivo: "Desenvolver uma calculadora funcional com as quatro operações aritmeticas básicas.", ferramentas: ["HTML5", "CSS3", "JavaScript"], passosSimplificados: ["Crie a grade visual dos botões com CSS Grid.", "Implemente seletores JavaScript para capturar cliques.", "Escreva a lógica para acumular valores e operadores.", "Compute o resultado no visor.", "Adicione botão de limpeza (clear)."], entregavel: "Calculadora interativa executada no navegador.", comoPublicar: "Vercel", sugestaoLinkedIn: "Desenvolvi uma calculadora interativa com HTML, CSS e JavaScript! Trabalhei lógica, eventos do DOM e CSS Grid.", proximoProjeto: "To-Do List Dinâmico" },
  { id: "todo-list-javascript", nome: "To-Do List Dinâmico", areaSlug: "frontend" as string | null, nivel: "Iniciante", objetivo: "Criar um gerenciador de tarefas que permite adicionar, marcar como concluídas e remover itens.", ferramentas: ["HTML5", "CSS3", "JavaScript"], passosSimplificados: ["Desenhe o formulário de entrada e a lista vazia.", "Crie funções para adicionar novos itens dinamicamente.", "Implemente alternancia de classe CSS de concluído.", "Crie botões de remoção individuais.", "Conecte ao LocalStorage para persistência."], entregavel: "Painel interativo de tarefas com persistência local.", comoPublicar: "GitHub Pages", sugestaoLinkedIn: "Finalizei um To-Do List em JavaScript puro! Aprendi manipulação de DOM e persistência com LocalStorage.", proximoProjeto: "Buscador de CEP" },
  { id: "buscador-cep-javascript", nome: "Buscador de Endereços por CEP", areaSlug: "frontend" as string | null, nivel: "Iniciante", objetivo: "Desenvolver uma aplicação que preenche automaticamente formulários de endereço a partir de um CEP.", ferramentas: ["HTML5", "CSS3", "JavaScript", "API ViaCEP"], passosSimplificados: ["Crie formulário com campos de CEP, Rua, Bairro, Cidade e Estado.", "Adicione ouvinte de evento no campo de CEP.", "Faça requisição assíncrona com Fetch API para a ViaCEP.", "Insira os dados de endereço nos campos do formulário.", "Implemente validações para CEPs inválidos."], entregavel: "Buscador inteligente de endereços dinâmico.", comoPublicar: "Netlify", sugestaoLinkedIn: "Desenvolvi um buscador de CEPs com a API ViaCEP usando Async/Await. Integração prática com API pública!", proximoProjeto: "App de Clima" },
  ...
  { id: "timer-pomodoro-javascript", nome: "Temporizador Pomodoro", areaSlug: "frontend" as string | null, nivel: "Intermediário", objetivo: "Criar um cronômetro regressivo com ciclos de foco e pausa seguindo a técnica Pomodoro.", ferramentas: ["HTML5", "CSS3", "JavaScript"], passosSimplificados: ["Defina variáveis de 25 minutos de foco e 5 de descanso.", "Crie botões de iniciar, pausar e reiniciar.", "Use setInterval para reduzir o tempo e atualizar a tela.", "Insira sinal sonoro ao terminar cada intervalo.", "Implemente alternancia automática entre ciclos."], entregavel: "Temporizador preciso e responsivo para produtividade.", comoPublicar: "Vercel", sugestaoLinkedIn: "Criei um temporizador Pomodoro completo em JavaScript! Aprendi setInterval e manipulação temporal.", proximoProjeto: "Quiz Interativo" },
  { id: "quiz-interativo-javascript", nome: "Quiz de Tecnologia Interativo", areaSlug: "frontend" as string | null, nivel: "Intermediário", objetivo: "Desenvolver um jogo de perguntas e respostas com feedback visual e contagem de pontos.", ferramentas: ["HTML5", "CSS3", "JavaScript"], passosSimplificados: ["Crie array de perguntas, opções e respostas corretas.", "Renderize uma pergunta por vez.", "Marque opções em verde ou vermelho conforme a seleção.", "Calcule pontuação acumulando acertos.", "Exiba tela de resultado com opção de reiniciar."], entregavel: "Quiz de multipla escolha que avalia o desempenho do usuário.", comoPublicar: "GitHub Pages", sugestaoLinkedIn: "Desenvolvi um Quiz Interativo em JavaScript moderno com feedback visual!", proximoProjeto: "Jogo da Memória" },
  { id: "jogo-da-memoria-javascript", nome: "Jogo da Memória Clássico", areaSlug: "frontend" as string | null, nivel: "Intermediário", objetivo: "Desenvolver o clássico jogo de combinar pares de cartas com animação de virada.", ferramentas: ["HTML5", "CSS3", "JavaScript"], passosSimplificados: ["Crie cartas com efeito CSS 3D de rotação.", "Embaralhe os pares aleatoriamente no carregamento.", "Limite a seleção a duas cartas por turno.", "Compare as cartas e mantenha ou desvire os pares.", "Exiba mensagem de parabéns ao completar todos os pares."], entregavel: "Jogo da memória interativo com animações fluidas.", comoPublicar: "Netlify", sugestaoLinkedIn: "Concluei um Jogo da Memória com CSS Transitions e JavaScript puro!", proximoProjeto: "App de Clima" },
  { id: "app-de-clima-javascript", nome: "Buscador de Clima em Tempo Real", areaSlug: "frontend" as string | null, nivel: "Intermediário", objetivo: "Criar um app que exibe temperatura, clima e umidade de qualquer cidade consumindo API meteorológica.", ferramentas: ["HTML5", "CSS3", "JavaScript", "OpenWeatherMap API"], passosSimplificados: ["Monte layout com campo de busca e cards de informações.", "Consuma a API OpenWeather com Fetch assíncrono.", "Extraia temperatura, sensação termica e umidade do JSON.", "Exiba os valores dinamicamente na tela.", "Valide e avise o usuário sobre cidades incorretas."], entregavel: "Aplicativo meteorologico responsivo com dados ao vivo.", comoPublicar: "Vercel", sugestaoLinkedIn: "Conectei minha aplicação JavaScript a API do OpenWeather para monitorar clima global!", proximoProjeto: "Gerador de Senhas" },
  ...
  { id: "blog-estatico-nextjs", nome: "Blog Estático Moderno", areaSlug: "frontend" as string | null, nivel: "Avançado", objetivo: "Desenvolver blog estático rápido e otimizado para SEO com artigos em Markdown.", ferramentas: ["Next.js", "TypeScript", "Tailwind CSS", "MDX"], passosSimplificados: ["Crie rotas dinâmicas baseadas em slugs.", "Configure leitores de Markdown para títulos e conteúdo.", "Use geração estática do Next.js para performance máxima.", "Estilize artigos com Tailwind Typography.", "Implemente busca rápida de posts."], entregavel: "Blog responsivo com alta pontuação Lighthouse.", comoPublicar: "Vercel", sugestaoLinkedIn: "Construí um blog de alto desempenho com Next.js e renderização estática!", proximoProjeto: "API REST com Node.js" },
  // BACKEND (15)
  { id: "api-tarefas-nodejs", nome: "API REST de Controle de Tarefas", areaSlug: "backend" as string | null, nivel: "Iniciante", objetivo: "Desenvolver backend de gerenciador de tarefas com operações CRUD usando Node.js.", ferramentas: ["Node.js", "Express", "MongoDB", "Mongoose"], passosSimplificados: ["Inicie o projeto e instale Express e Mongoose.", "Conecte ao MongoDB Atlas.", "Defina o schema de dados com título, descrição e status.", "Crie rotas HTTP para CRUD completo.", "Adicione validadores e códigos HTTP corretos."], entregavel: "API REST funcional testável via Postman.", comoPublicar: "Render", sugestaoLinkedIn: "Construí uma API REST com Node.js, Express e MongoDB!", proximoProjeto: "API de Autenticação JWT" },
  { id: "api-autenticacao-jwt", nome: "API de Autenticação JWT", areaSlug: "backend" as string | null, nivel: "Iniciante", objetivo: "Construir mecanismo de registro, login e controle de acesso com tokens JWT.", ferramentas: ["Node.js", "Express", "bcryptjs", "jsonwebtoken", "PostgreSQL"], passosSimplificados: ["Configure tabelas de usuários no banco.", "Implemente rota de cadastro com hashing de senha.", "Desenvolva rota de login gerando token JWT.", "Crie middleware para autenticar tokens nos headers.", "Proteja endpoints exigindo autenticação."], entregavel: "Barramento de segurança completo para endpoints privados.", comoPublicar: "Railway", sugestaoLinkedIn: "Implementei autenticação completa com bcrypt e JWT em Node.js!", proximoProjeto: "CRUD com Java Spring Boot" },
  ...
  { id: "encurtador-url-php", nome: "Encurtador de Links", areaSlug: "backend" as string | null, nivel: "Intermediário", objetivo: "Desenvolver serviço de encurtamento de URLs com redirecionamento rápido.", ferramentas: ["PHP", "Apache", "MySQL"], passosSimplificados: ["Crie tabela MySQL para URLs originais e hashes.", "Valide e higienize os links recebidos.", "Gere e salve hashes compactas.", "Implemente redirecionamento HTTP via banco.", "Adicione painel com contagem de cliques."], entregavel: "Redirecionador de endereços com painel de relatórios.", comoPublicar: "Hostinger ou 000webhost", sugestaoLinkedIn: "Construí encurtador de links em PHP com MySQL!", proximoProjeto: "Notificador por E-mail" },
  ...
  // DADOS (15)
  { id: "analise-exploratoria-pandas", nome: "Análise Exploratória com Pandas", areaSlug: "dados" as string | null, nivel: "Iniciante", objetivo: "Explorar um dataset público para extrair padrões e gerar visualizações básicas.", ferramentas: ["Python", "Pandas", "Matplotlib", "Seaborn", "Jupyter Notebook"], passosSimplificados: ["Baixe um dataset público do Kaggle (ex.: Titanic, Iris).", "Carregue o dataset com Pandas e verifique os tipos e valores nulos.", "Gere estatísticas descritivas com df.describe().", "Crie gráficos de distribuição e correlação com Seaborn.", "Documente os insights encontrados no Jupyter."], entregavel: "Notebook Jupyter com análise completa e gráficos comentados.", comoPublicar: "GitHub ou Kaggle Notebooks", sugestaoLinkedIn: "Realizei minha primeira análise exploratória de dados com Python e Pandas!", proximoProjeto: "Dashboard no Power BI" },
  ...
  { id: "analise-sentimento-tweets", nome: "Análise de Sentimento de Textos", areaSlug: "dados" as string | null, nivel: "Intermediário", objetivo: "Classificar textos como positivos, negativos ou neutros usando NLP básico.", ferramentas: ["Python", "TextBlob", "Pandas", "Matplotlib", "Jupyter Notebook"], passosSimplificados: ["Colete textos via CSV ou API pública.", "Aplique TextBlob para calcular polaridade de cada texto.", "Classifique em positivo, negativo ou neutro.", "Visualize a distribuição de sentimentos com gráficos.", "Documente exemplos de cada categoria."], entregavel: "Análise de sentimentos documentada com visualizações e exemplos.", comoPublicar: "GitHub ou Kaggle", sugestaoLinkedIn: "Realizei análise de sentimento de textos com Python e NLP!", proximoProjeto: "Análise de COVID-19" },
  ...
  { id: "analise-churn-python", nome: "Análise de Cancelamento de Clientes", areaSlug: "dados" as string | null, nivel: "Avançado", objetivo: "Identificar padrões de cancelamento de clientes e construir modelo preditivo.", ferramentas: ["Python", "Pandas", "scikit-learn", "Seaborn", "Jupyter Notebook"], passosSimplificados: ["Carregue dataset de churn (ex.: Telco Customer Churn do Kaggle).", "Analise variáveis que mais impactam o cancelamento.", "Treine modelo de classificação com Random Forest.", "Avalie com métricas de precisão, recall e AUC-ROC.", "Apresente os 5 principais fatores de churn."], entregavel: "Modelo preditivo de churn com relatório de variáveis mais relevantes.", comoPublicar: "GitHub ou Kaggle", sugestaoLinkedIn: "Construí modelo de predição de churn com scikit-learn e Random Forest!", proximoProjeto: "Segmentação de Clientes" },
  ...
  { id: "chatbot-langchain", nome: "Chatbot com LangChain e OpenAI", areaSlug: "ia" as string | null, nivel: "Iniciante", objetivo: "Construir assistente de perguntas e respostas usando LLM com memória de conversação.", ferramentas: ["Python", "LangChain", "OpenAI API", "Streamlit"], passosSimplificados: ["Configure API key da OpenAI.", "Inicie chain com memória de conversação no LangChain.", "Crie interface de chat com Streamlit.", "Adicione histórico de mensagens na interface.", "Teste com diferentes perguntas e fluxos."], entregavel: "Chatbot conversacional com memória deployado no Streamlit.", comoPublicar: "Streamlit Cloud", sugestaoLinkedIn: "Construí chatbot com LangChain e GPT com memória de conversação!", proximoProjeto: "Reconhecimento de Dígitos" },
  { id: "reconhecimento-digitos-mnist", nome: "Reconhecimento de Dígitos com Redes Neurais", areaSlug: "ia" as string | null, nivel: "Iniciante", objetivo: "Treinar rede neural para reconhecer dígitos manuscritos no dataset MNIST.", ferramentas: ["Python", "TensorFlow", "Keras", "Matplotlib", "Jupyter Notebook"], passosSimplificados: ["Carregue o dataset MNIST via Keras.", "Normalize os pixels entre 0 e 1.", "Construa rede neural com camadas Dense.", "Treine por 10 epochs e avalie a acurácia.", "Visualize predicoes erradas do modelo."], entregavel: "Modelo treinado com acurácia acima de 97% e exemplos de predição.", comoPublicar: "GitHub ou Kaggle", sugestaoLinkedIn: "Treinei rede neural para reconhecer dígitos manuscritos com TensorFlow!", proximoProjeto: "Sistema de Recomendação" },
  ...
  { id: "pesquisa-usuarios-formulario", nome: "Pesquisa de Usuários com Formulário", areaSlug: "uxui" as string | null, nivel: "Intermediário", objetivo: "Planejar e executar pesquisa qualitativa com usuários reais para validar uma hipótese.", ferramentas: ["Google Forms", "Notion", "Miro"], passosSimplificados: ["Defina a hipótese a ser validada.", "Crie roteiro de entrevista com 8 perguntas.", "Recrute e entreviste 5 participantes.", "Organize as respostas em mapa de afinidade no Miro.", "Extraia insights e recomendações de design."], entregavel: "Relatório de pesquisa com insights priorizados e recomendações.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Conduzi pesquisa com usuários reais e transformei insights em decisões de design!", proximoProjeto: "Mapa de Jornada do Cliente" },
  { id: "mapa-jornada-cliente", nome: "Mapa de Jornada do Cliente", areaSlug: "uxui" as string | null, nivel: "Intermediário", objetivo: "Mapear a experiência completa de um usuário em contato com um produto ou serviço.", ferramentas: ["Miro", "FigJam", "Notion"], passosSimplificados: ["Defina a persona e o cenário.", "Liste todas as etapas da jornada.", "Identifique ações, emoções e pontos de dor.", "Marque oportunidades de melhoria em cada etapa.", "Apresente o mapa com recomendações priorizadas."], entregavel: "Mapa de jornada visual com insights e oportunidades mapeadas.", comoPublicar: "Miro ou Notion publicado", sugestaoLinkedIn: "Mapeei a jornada completa de um usuário e identifiquei oportunidades de melhoria!", proximoProjeto: "UI Kit de Componentes" },
  ...
  // QA (15)
  { id: "automacao-login-cypress", nome: "Automação de Login com Cypress", areaSlug: "qa" as string | null, nivel: "Iniciante", objetivo: "Automatizar o fluxo de login de uma aplicação web com Cypress.", ferramentas: ["Cypress", "JavaScript", "Node.js"], passosSimplificados: ["Instale Cypress no projeto.", "Crie spec de login com cy.visit e cy.get.", "Cubra cenários de sucesso e credenciais inválidas.", "Adicione verificação de redirecionamento após login.", "Execute os testes e verifique o relatório."], entregavel: "Suite de testes de login com 5 cenários automatizados.", comoPublicar: "GitHub", sugestaoLinkedIn: "Automatizei fluxo de login com Cypress cobrindo cenários de sucesso e erro!", proximoProjeto: "Testes de API com Postman" },
  ...
  { id: "testes-e2e-playwright", nome: "Testes End-to-End com Playwright", areaSlug: "qa" as string | null, nivel: "Iniciante", objetivo: "Automatizar fluxo completo de compra em e-commerce com Playwright.", ferramentas: ["Playwright", "TypeScript", "Node.js"], passosSimplificados: ["Instale Playwright e configure o projeto.", "Crie testes para busca, adicionar ao carrinho e checkout.", "Use page objects para organizar os seletores.", "Execute em múltiplos navegadores.", "Gere relatório HTML dos resultados."], entregavel: "Suite E2E cobrindo fluxo de compra em 3 navegadores.", comoPublicar: "GitHub", sugestaoLinkedIn: "Automatizei fluxo E2E de compra com Playwright em múltiplos browsers!", proximoProjeto: "Plano de Testes" },
  ...
  { id: "performance-jmeter", nome: "Testes de Performance com JMeter", areaSlug: "qa" as string | null, nivel: "Intermediário", objetivo: "Executar testes de carga em API REST e analisar os resultados de performance.", ferramentas: ["Apache JMeter", "Java"], passosSimplificados: ["Configure JMeter com Thread Group de 100 usuários.", "Adicione HTTP Request para o endpoint a testar.", "Configure ramp-up de 60 segundos.", "Execute o teste e colete métricas.", "Analise tempo de resposta, throughput e erros."], entregavel: "Relatório de performance com gráficos e análise dos resultados.", comoPublicar: "GitHub ou PDF", sugestaoLinkedIn: "Executei testes de carga com JMeter e analisei performance de API REST!", proximoProjeto: "Automação de Formulário" },
  ...
  { id: "pipeline-testes-github-actions", nome: "Pipeline de Testes no GitHub Actions", areaSlug: "qa" as string | null, nivel: "Avançado", objetivo: "Configurar pipeline de CI que executa toda a suite de testes a cada push.", ferramentas: ["GitHub Actions", "Cypress", "Node.js"], passosSimplificados: ["Crie arquivo .github/workflows/tests.yml.", "Configure o job para instalar dependências.", "Execute os testes em ambiente de CI.", "Salve os artefatos de vídeo e screenshots.", "Configure notificação de falha por email."], entregavel: "Pipeline CI funcional com execução automática de testes.", comoPublicar: "GitHub com Actions configurado", sugestaoLinkedIn: "Configurei pipeline de CI com GitHub Actions executando testes automaticamente!", proximoProjeto: "Cobertura de Testes" },
  ...
  { id: "pesquisa-discovery", nome: "Pesquisa de Discovery com Entrevistas", areaSlug: "produto" as string | null, nivel: "Intermediário", objetivo: "Conduzir pesquisa de discovery para validar hipóteses de produto com usuários reais.", ferramentas: ["Notion", "Zoom", "Miro"], passosSimplificados: ["Defina as hipóteses a validar.", "Crie roteiro de entrevista com 10 perguntas abertas.", "Recrute e entreviste 5 usuários.", "Organize respostas em mapa de afinidade.", "Extraia insights e invalide ou confirme hipóteses."], entregavel: "Relatório de discovery com hipóteses validadas e próximas ações.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Conduzi 5 entrevistas de discovery e validei hipóteses de produto!", proximoProjeto: "Análise de Métricas" },
  { id: "analise-metricas-retencao", nome: "Análise de Métricas de Retenção", areaSlug: "produto" as string | null, nivel: "Intermediário", objetivo: "Analisar métricas de retenção de usuários e propor ações de melhoria.", ferramentas: ["Google Analytics", "Amplitude", "Mixpanel", "Excel"], passosSimplificados: ["Acesse dados de retenção D1, D7 e D30.", "Identifique onde os usuários abandonam o produto.", "Segmente a análise por canal de aquisição.", "Proponha 3 hipóteses de melhoria.", "Defina experimentos para testar cada hipótese."], entregavel: "Relatório de retenção com análise de funil e hipóteses de melhoria.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Analisei métricas de retenção e propus hipóteses de melhoria baseadas em dados!", proximoProjeto: "Priorização RICE" },
  ...
  { id: "plano-lancamento-feature", nome: "Plano de Lançamento de Feature", areaSlug: "produto" as string | null, nivel: "Avançado", objetivo: "Planejar o lançamento de uma feature nova com estratégia de comunicação e medição.", ferramentas: ["Notion", "Trello", "Google Analytics"], passosSimplificados: ["Defina a data de lançamento e critérios de go/no-go.", "Planeje a comunicação para usuários e stakeholders.", "Configure feature flags para lançamento gradual.", "Defina as métricas de sucesso do lançamento.", "Crie plano de rollback em caso de problemas."], entregavel: "Plano de lançamento com checklist, comunicação e métricas.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Planejei lançamento de feature com estratégia de rollout gradual e plano de rollback!", proximoProjeto: "Análise de Funil" },
  ...
  { id: "hipoteses-teste-ab", nome: "Hipóteses e Design de Teste A/B", areaSlug: "produto" as string | null, nivel: "Avançado", objetivo: "Formular hipóteses e desenhar testes A/B para otimizar métricas de produto.", ferramentas: ["Notion", "Google Optimize", "Excel"], passosSimplificados: ["Defina a métrica a otimizar.", "Formule hipótese no formato Se/Então/Porque.", "Calcule o tamanho de amostra necessário.", "Desenhe as variantes de controle e tratamento.", "Documente o critério de sucesso e duração do teste."], entregavel: "Design de 3 testes A/B com hipóteses e critérios de sucesso.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Desenhei testes A/B com hipóteses estruturadas e cálculo de tamanho de amostra!", proximoProjeto: "Personas de Usuário" },
