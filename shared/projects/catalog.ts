...
export const projetos: ProjetoCatalogo[] = [
  ...
  // UX/UI (15)
  { id: "redesign-app-bancario", nome: "Redesign de App Bancario", areaSlug: "uxui" as string | null, nivel: "Iniciante", objetivo: "Reprojetar a experiencia de um app bancario real melhorando usabilidade e clareza visual.", ferramentas: ["Figma"], passosSimplificados: ["Escolha um app bancario para redesenhar.", "Faca auditoria de usabilidade identificando problemas.", "Crie wireframes das telas principais.", "Desenvolva o design de alta fidelidade no Figma.", "Monte o prototipo interativo e documente as decisoes."], entregavel: "Prototipo de alta fidelidade com justificativas de design.", comoPublicar: "Behance ou link do Figma", sugestaoLinkedIn: "Fiz o redesign de um app bancario no Figma focando em usabilidade!", proximoProjeto: "Design System Basico" },
  { id: "design-system-basico", nome: "Design System Basico", areaSlug: "uxui" as string | null, nivel: "Iniciante", objetivo: "Criar biblioteca de componentes reutilizaveis com tokens de design no Figma.", ferramentas: ["Figma"], passosSimplificados: ["Defina tokens de cor, tipografia e espacamento.", "Crie componentes atomicos: botoes, inputs, badges.", "Monte componentes moleculares: cards, formularios.", "Documente o uso de cada componente.", "Publique a biblioteca no Figma para uso compartilhado."], entregavel: "Design system com 20 componentes documentados e publicados.", comoPublicar: "Figma Community ou Behance", sugestaoLinkedIn: "Criei meu primeiro design system no Figma com componentes e tokens!", proximoProjeto: "Teste de Usabilidade com Maze" },
  { id: "teste-usabilidade-maze", nome: "Teste de Usabilidade com Maze", areaSlug: "uxui" as string | null, nivel: "Iniciante", objetivo: "Conduzir teste de usabilidade remoto em prototipo do Figma usando a plataforma Maze.", ferramentas: ["Figma", "Maze"], passosSimplificados: ["Crie prototipo de fluxo de compra no Figma.", "Importe o prototipo no Maze.", "Configure tarefas e missoes para os participantes.", "Colete respostas de pelo menos 5 testadores.", "Analise taxas de conclusao e pontos de abandono."], entregavel: "Relatorio de usabilidade com heatmaps e insights priorizados.", comoPublicar: "Notion ou PDF exportado", sugestaoLinkedIn: "Conduzi teste de usabilidade remoto com Maze e coletei insights valiosos!", proximoProjeto: "Wireframes de E-commerce" },
  { id: "wireframes-ecommerce", nome: "Wireframes de E-commerce", areaSlug: "uxui" as string | null, nivel: "Iniciante", objetivo: "Criar wireframes de baixa fidelidade de uma loja virtual do zero ate o checkout.", ferramentas: ["Figma", "FigJam"], passosSimplificados: ["Mapeie o fluxo do usuario em FigJam.", "Crie wireframes de home, listagem, produto e checkout.", "Valide o fluxo com pelo menos 2 colegas.", "Anote feedback e refine os wireframes.", "Documente as decisoes de arquitetura de informacao."], entregavel: "Wireframes completos do fluxo de compra com anotacoes.", comoPublicar: "Link do Figma ou Behance", sugestaoLinkedIn: "Criei wireframes de um e-commerce do mapa de fluxo ate o checkout!", proximoProjeto: "Prototipo de Onboarding" },
  { id: "prototipo-onboarding", nome: "Prototipo de Fluxo de Onboarding", areaSlug: "uxui" as string | null, nivel: "Intermediário", objetivo: "Projetar experiencia de primeiro uso de um app com telas de boas-vindas e configuracao.", ferramentas: ["Figma"], passosSimplificados: ["Pesquise onboardings de referencia (Duolingo, Notion, etc.).", "Defina as informacoes essenciais para coletar no primeiro acesso.", "Crie wireframes das telas de onboarding.", "Desenvolva o design de alta fidelidade.", "Prototipe as transicoes e teste com 3 usuarios."], entregavel: "Prototipo interativo de onboarding com relatorio de testes.", comoPublicar: "Figma ou Behance", sugestaoLinkedIn: "Desenhei um fluxo de onboarding completo com testes de usabilidade!", proximoProjeto: "Fluxo de Checkout" },
  { id: "fluxo-checkout-otimizado", nome: "Fluxo de Checkout Otimizado", areaSlug: "uxui" as string | null, nivel: "Intermediário", objetivo: "Redesenhar o fluxo de pagamento de um e-commerce para reduzir abandono de carrinho.", ferramentas: ["Figma", "Maze"], passosSimplificados: ["Analise o fluxo de checkout atual de um e-commerce.", "Identifique os pontos de fricao e abandono.", "Redesenhe o fluxo em no maximo 3 etapas.", "Adicione indicadores de progresso e microinteracoes.", "Valide com teste de usabilidade no Maze."], entregavel: "Novo fluxo de checkout com comparativo antes e depois.", comoPublicar: "Behance ou Figma", sugestaoLinkedIn: "Reduzi fricao no checkout redesenhando o fluxo com foco em conversao!", proximoProjeto: "App de Delivery no Figma" },
  { id: "app-delivery-figma", nome: "App de Delivery no Figma", areaSlug: "uxui" as string | null, nivel: "Intermediário", objetivo: "Criar interface completa de app de entrega de comida do cardapio ao rastreamento.", ferramentas: ["Figma"], passosSimplificados: ["Analise referencias como iFood e Rappi.", "Crie o sistema de cores e tipografia.", "Desenvolva telas: home, restaurante, pedido e rastreamento.", "Construa prototipo navegavel.", "Documente o processo de design."], entregavel: "App de delivery com 8 telas e prototipo interativo.", comoPublicar: "Behance com link do Figma", sugestaoLinkedIn: "Desenhei app de delivery completo com 8 telas no Figma!", proximoProjeto: "Pesquisa com Usuarios" },
  { id: "pesquisa-usuarios-formulario", nome: "Pesquisa de Usuarios com Formulario", areaSlug: "uxui" as string | null, nivel: "Intermediário", objetivo: "Planejar e executar pesquisa qualitativa com usuarios reais para validar uma hipotese.", ferramentas: ["Google Forms", "Notion", "Miro"], passosSimplificados: ["Defina a hipotese a ser validada.", "Crie roteiro de entrevista com 8 perguntas.", "Recrute e entreviste 5 participantes.", "Organize as respostas em mapa de afinidade no Miro.", "Extraia insights e recomendacoes de design."], entregavel: "Relatorio de pesquisa com insights priorizados e recomendacoes.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Conduzi pesquisa com usuarios reais e transformei insights em decisoes de design!", proximoProjeto: "Mapa de Jornada do Cliente" },
  { id: "mapa-jornada-cliente", nome: "Mapa de Jornada do Cliente", areaSlug: "uxui" as string | null, nivel: "Intermediário", objetivo: "Mapear a experiencia completa de um usuario em contato com um produto ou servico.", ferramentas: ["Miro", "FigJam", "Notion"], passosSimplificados: ["Defina a persona e o cenario.", "Liste todas as etapas da jornada.", "Identifique acoes, emocoes e pontos de dor.", "Marque oportunidades de melhoria em cada etapa.", "Apresente o mapa com recomendacoes priorizadas."], entregavel: "Mapa de jornada visual com insights e oportunidades mapeadas.", comoPublicar: "Miro ou Notion publicado", sugestaoLinkedIn: "Mapeei a jornada completa de um usuario e identifiquei oportunidades de melhoria!", proximoProjeto: "UI Kit de Componentes" },
  { id: "ui-kit-componentes", nome: "UI Kit com Auto Layout", areaSlug: "uxui" as string | null, nivel: "Avançado", objetivo: "Criar kit de interface responsivo usando Auto Layout avancado do Figma.", ferramentas: ["Figma"], passosSimplificados: ["Defina os fundamentos visuais do kit.", "Crie todos os estados dos componentes basicos.", "Use Auto Layout para comportamento responsivo.", "Monte composicoes de pagina usando apenas o kit.", "Documente as regras de uso de cada componente."], entregavel: "UI kit com 40 componentes usando Auto Layout avancado.", comoPublicar: "Figma Community", sugestaoLinkedIn: "Publiquei UI kit com Auto Layout avancado na comunidade do Figma!", proximoProjeto: "Dashboard Administrativo" },
  { id: "dashboard-administrativo-figma", nome: "Dashboard Administrativo no Figma", areaSlug: "uxui" as string | null, nivel: "Avançado", objetivo: "Projetar painel administrativo complexo com tabelas, graficos e filtros avancados.", ferramentas: ["Figma"], passosSimplificados: ["Defina os KPIs e dados a serem exibidos.", "Crie o layout em grid com areas bem definidas.", "Projete graficos, tabelas e cards de metricas.", "Adicione estados de loading e vazio.", "Monte prototipo interativo dos filtros principais."], entregavel: "Dashboard de alta fidelidade com prototipo dos principais fluxos.", comoPublicar: "Behance ou Figma", sugestaoLinkedIn: "Desenhei dashboard administrativo complexo com foco em densidade de informacao!", proximoProjeto: "App de Saude" },
  { id: "app-saude-figma", nome: "App de Saude e Bem-Estar", areaSlug: "uxui" as string | null, nivel: "Avançado", objetivo: "Criar app de acompanhamento de saude com visualizacoes de dados pessoais.", ferramentas: ["Figma"], passosSimplificados: ["Pesquise apps de saude como referencia.", "Defina as metricas de saude a acompanhar.", "Crie a identidade visual e sistema de cores.", "Desenvolva telas de dashboard, historico e metas.", "Prototipe as interacoes principais e teste."], entregavel: "App de saude com 10 telas e identidade visual propria.", comoPublicar: "Behance com link do Figma", sugestaoLinkedIn: "Desenhei app de saude com visualizacao de dados pessoais!", proximoProjeto: "Landing Page Responsiva" },
  { id: "landing-page-responsiva-figma", nome: "Landing Page Responsiva no Figma", areaSlug: "uxui" as string | null, nivel: "Avançado", objetivo: "Criar landing page de produto com versoes desktop, tablet e mobile no Figma.", ferramentas: ["Figma"], passosSimplificados: ["Defina a proposta de valor e hierarquia de informacao.", "Crie versao desktop primeiro.", "Adapte o layout para tablet (768px).", "Crie versao mobile (375px).", "Documente o comportamento responsivo dos componentes."], entregavel: "Landing page em 3 breakpoints com guia de responsividade.", comoPublicar: "Behance ou Figma Community", sugestaoLinkedIn: "Criei landing page responsiva em 3 breakpoints no Figma!", proximoProjeto: "Clone do Tela do Airbnb" },
  { id: "clone-tela-airbnb", nome: "Clone de Tela do Airbnb", areaSlug: "uxui" as string | null, nivel: "Avançado", objetivo: "Recriar fielmente a interface do Airbnb como exercicio de precisao e atencao aos detalhes.", ferramentas: ["Figma"], passosSimplificados: ["Escolha uma pagina do Airbnb para recriar.", "Identifique a grade e o sistema de espacamento.", "Recrie os componentes com precisao de pixels.", "Compare lado a lado com o original.", "Documente o que aprendeu sobre a arquitetura visual."], entregavel: "Clone fiel com anotacoes de aprendizado tecnico.", comoPublicar: "Behance ou Figma", sugestaoLinkedIn: "Recriei fielmente uma tela do Airbnb para exercitar precisao de design!", proximoProjeto: "Sistema de Icones" },
  { id: "sistema-icones-svg", nome: "Sistema de Icones SVG Personalizados", areaSlug: "uxui" as string | null, nivel: "Avançado", objetivo: "Criar set de icones originais e coerentes para um produto digital.", ferramentas: ["Figma", "Illustrator"], passosSimplificados: ["Defina o estilo visual: outline, filled ou duotone.", "Crie uma grade de 24x24px consistente.", "Desenhe 30 icones originais no mesmo estilo.", "Exporte em SVG otimizado.", "Documente as regras de uso e tamanhos."], entregavel: "Set de 30 icones SVG originais com documentacao.", comoPublicar: "Figma Community ou GitHub", sugestaoLinkedIn: "Criei set de icones SVG originais com estilo consistente!", proximoProjeto: "Design System Avancado" },
  // QA (15)
  { id: "automacao-login-cypress", nome: "Automacao de Login com Cypress", areaSlug: "qa" as string | null, nivel: "Iniciante", objetivo: "Automatizar o fluxo de login de uma aplicacao web com Cypress.", ferramentas: ["Cypress", "JavaScript", "Node.js"], passosSimplificados: ["Instale Cypress no projeto.", "Crie spec de login com cy.visit e cy.get.", "Cubra cenarios de sucesso e credenciais invalidas.", "Adicione verificacao de redirecionamento apos login.", "Execute os testes e verifique o relatorio."], entregavel: "Suite de testes de login com 5 cenarios automatizados.", comoPublicar: "GitHub", sugestaoLinkedIn: "Automatizei fluxo de login com Cypress cobrindo cenarios de sucesso e erro!", proximoProjeto: "Testes de API com Postman" },
  { id: "testes-api-postman", nome: "Testes de API com Postman", areaSlug: "qa" as string | null, nivel: "Iniciante", objetivo: "Criar colecao de testes automatizados para uma API REST publica no Postman.", ferramentas: ["Postman"], passosSimplificados: ["Escolha uma API publica (JSONPlaceholder, ViaCEP).", "Crie colecao com requisicoes GET, POST, PUT, DELETE.", "Adicione assertions nos scripts de testes.", "Configure variaveis de ambiente.", "Execute a colecao e analise o relatorio."], entregavel: "Colecao Postman com 15 testes automatizados exportada.", comoPublicar: "GitHub ou Postman Public Workspace", sugestaoLinkedIn: "Criei suite de testes de API REST automatizados no Postman!", proximoProjeto: "Testes E2E com Playwright" },
  { id: "testes-e2e-playwright", nome: "Testes End-to-End com Playwright", areaSlug: "qa" as string | null, nivel: "Iniciante", objetivo: "Automatizar fluxo completo de compra em e-commerce com Playwright.", ferramentas: ["Playwright", "TypeScript", "Node.js"], passosSimplificados: ["Instale Playwright e configure o projeto.", "Crie testes para busca, adicionar ao carrinho e checkout.", "Use page objects para organizar os seletores.", "Execute em multiplos navegadores.", "Gere relatorio HTML dos resultados."], entregavel: "Suite E2E cobrindo fluxo de compra em 3 navegadores.", comoPublicar: "GitHub", sugestaoLinkedIn: "Automatizei fluxo E2E de compra com Playwright em multiplos browsers!", proximoProjeto: "Plano de Testes" },
  { id: "bdd-cucumber-javascript", nome: "Testes BDD com Cucumber", areaSlug: "qa" as string | null, nivel: "Intermediário", objetivo: "Implementar testes em linguagem Gherkin com Cucumber integrado ao Cypress.", ferramentas: ["Cypress", "Cucumber", "JavaScript"], passosSimplificados: ["Instale o plugin Cypress-Cucumber-Preprocessor.", "Escreva cenarios em Gherkin no arquivo .feature.", "Implemente os step definitions em JavaScript.", "Execute os cenarios e verifique o resultado.", "Compartilhe os arquivos .feature com a equipe."], entregavel: "Suite BDD com cenarios em Gherkin e steps implementados.", comoPublicar: "GitHub", sugestaoLinkedIn: "Implementei testes BDD com Cucumber e Cypress usando linguagem Gherkin!", proximoProjeto: "Relatorio de Bugs" },
  { id: "relatorio-bugs-documentado", nome: "Relatorio de Bugs Documentado", areaSlug: "qa" as string | null, nivel: "Intermediário", objetivo: "Executar sessao de testes exploratarios e documentar bugs de forma profissional.", ferramentas: ["Jira", "Notion", "Chrome DevTools"], passosSimplificados: ["Escolha uma aplicacao web real para explorar.", "Execute sessao de 1 hora de testes exploratarios.", "Documente cada bug com titulo, passos, esperado e atual.", "Adicione evidencias com screenshots e videos.", "Classifique por severidade e prioridade."], entregavel: "Relatorio com 10 bugs documentados profissionalmente no Jira ou Notion.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Conduzi sessao de testes exploratarios e documentei 10 bugs profissionalmente!", proximoProjeto: "Testes Mobile com Appium" },
  { id: "testes-mobile-appium", nome: "Testes Mobile com Appium", areaSlug: "qa" as string | null, nivel: "Intermediário", objetivo: "Automatizar testes em aplicativo Android usando Appium.", ferramentas: ["Appium", "Python", "Android Studio", "Android Emulator"], passosSimplificados: ["Configure Appium Server e emulador Android.", "Instale o driver UiAutomator2.", "Crie script de teste para fluxo de login.", "Use locators adequados para elementos mobile.", "Execute no emulador e valide os resultados."], entregavel: "Suite de testes mobile automatizados para fluxo de login.", comoPublicar: "GitHub", sugestaoLinkedIn: "Automatizei testes mobile com Appium no Android!", proximoProjeto: "Testes Unitarios em JavaScript" },
  { id: "testes-unitarios-jest", nome: "Testes Unitarios com Jest", areaSlug: "qa" as string | null, nivel: "Intermediário", objetivo: "Criar suite de testes unitarios para funcoes JavaScript com Jest.", ferramentas: ["Jest", "JavaScript", "Node.js"], passosSimplificados: ["Instale Jest no projeto.", "Escreva funcoes puras a serem testadas.", "Crie arquivos .test.js para cada modulo.", "Cubra casos felizes e casos de erro.", "Execute e verifique a cobertura de codigo."], entregavel: "Suite de testes unitarios com 80% de cobertura de codigo.", comoPublicar: "GitHub", sugestaoLinkedIn: "Criei suite de testes unitarios com Jest atingindo 80% de cobertura!", proximoProjeto: "Performance com JMeter" },
  { id: "performance-jmeter", nome: "Testes de Performance com JMeter", areaSlug: "qa" as string | null, nivel: "Intermediário", objetivo: "Executar testes de carga em API REST e analisar os resultados de performance.", ferramentas: ["Apache JMeter", "Java"], passosSimplificados: ["Configure JMeter com Thread Group de 100 usuarios.", "Adicione HTTP Request para o endpoint a testar.", "Configure ramp-up de 60 segundos.", "Execute o teste e colete metricas.", "Analise tempo de resposta, throughput e erros."], entregavel: "Relatorio de performance com graficos e analise dos resultados.", comoPublicar: "GitHub ou PDF", sugestaoLinkedIn: "Executei testes de carga com JMeter e analisei performance de API REST!", proximoProjeto: "Automacao de Formulario" },
  { id: "automacao-formulario-selenium", nome: "Automacao de Formulario com Selenium", areaSlug: "qa" as string | null, nivel: "Avançado", objetivo: "Automatizar preenchimento e validacao de formulario complexo com Selenium.", ferramentas: ["Selenium WebDriver", "Python", "pytest"], passosSimplificados: ["Configure Selenium WebDriver com ChromeDriver.", "Implemente Page Object Model para o formulario.", "Automatize preenchimento de todos os campos.", "Valide mensagens de erro para cada campo.", "Integre com pytest para relatorio estruturado."], entregavel: "Suite de automacao de formulario com Page Object e relatorio.", comoPublicar: "GitHub", sugestaoLinkedIn: "Automatizei formulario complexo com Selenium e Page Object Model!", proximoProjeto: "Testes de Regressao" },
  { id: "testes-regressao-suite", nome: "Suite de Testes de Regressao", areaSlug: "qa" as string | null, nivel: "Avançado", objetivo: "Criar suite de regressao completa para garantir que features existentes nao quebram.", ferramentas: ["Cypress", "JavaScript", "GitHub Actions"], passosSimplificados: ["Mapeie as funcionalidades criticas da aplicacao.", "Crie testes para cada funcionalidade principal.", "Organize em tags de smoke e regressao completa.", "Configure pipeline no GitHub Actions.", "Execute automaticamente a cada pull request."], entregavel: "Suite de regressao integrada ao CI/CD com execucao automatica.", comoPublicar: "GitHub com Actions configurado", sugestaoLinkedIn: "Implementei suite de regressao automatica integrada ao CI/CD com Cypress!", proximoProjeto: "Testes de Acessibilidade" },
  { id: "testes-acessibilidade-axe", nome: "Testes de Acessibilidade com Axe", areaSlug: "qa" as string | null, nivel: "Avançado", objetivo: "Validar conformidade WCAG de uma aplicacao web usando ferramentas de acessibilidade.", ferramentas: ["Cypress", "axe-core", "Lighthouse"], passosSimplificados: ["Instale o plugin cypress-axe.", "Execute scan de acessibilidade em cada pagina.", "Corrija violacoes criticas identificadas.", "Execute Lighthouse para validar contraste e semantica.", "Documente o relatorio de conformidade WCAG."], entregavel: "Relatorio de acessibilidade com violacoes e correcoes aplicadas.", comoPublicar: "GitHub ou PDF", sugestaoLinkedIn: "Auditei acessibilidade WCAG com Cypress e axe-core!", proximoProjeto: "Pipeline de Testes CI" },
  { id: "pipeline-testes-github-actions", nome: "Pipeline de Testes no GitHub Actions", areaSlug: "qa" as string | null, nivel: "Avançado", objetivo: "Configurar pipeline de CI que executa toda a suite de testes a cada push.", ferramentas: ["GitHub Actions", "Cypress", "Node.js"], passosSimplificados: ["Crie arquivo .github/workflows/tests.yml.", "Configure o job para instalar dependencias.", "Execute os testes em ambiente de CI.", "Salve os artefatos de video e screenshots.", "Configure notificacao de falha por email."], entregavel: "Pipeline CI funcional com execucao automatica de testes.", comoPublicar: "GitHub com Actions configurado", sugestaoLinkedIn: "Configurei pipeline de CI com GitHub Actions executando testes automaticamente!", proximoProjeto: "Cobertura de Testes" },
  { id: "analise-cobertura-testes", nome: "Analise e Aumento de Cobertura de Testes", areaSlug: "qa" as string | null, nivel: "Avançado", objetivo: "Aumentar a cobertura de testes de um projeto de 40% para 80%.", ferramentas: ["Jest", "Istanbul", "JavaScript"], passosSimplificados: ["Execute relatorio de cobertura atual com Istanbul.", "Identifique as funcoes com menos testes.", "Escreva testes para os casos nao cobertos.", "Priorize logicas de negocio criticas.", "Documente a evolucao da cobertura."], entregavel: "Projeto com cobertura aumentada de 40% para 80% documentada.", comoPublicar: "GitHub com badge de cobertura", sugestaoLinkedIn: "Aumentei a cobertura de testes de 40% para 80% com Jest e Istanbul!", proximoProjeto: "Testes de Contrato" },
  { id: "relatorio-qualidade-software", nome: "Relatorio Completo de Qualidade", areaSlug: "qa" as string | null, nivel: "Avançado", objetivo: "Produzir relatorio executivo de qualidade de software ao final de um ciclo de testes.", ferramentas: ["Jira", "Notion", "Excel", "TestRail"], passosSimplificados: ["Consolide os resultados de todos os testes executados.", "Calcule metricas de cobertura, defeitos e densidade.", "Crie graficos de progresso e tendencia.", "Avalie riscos residuais.", "Escreva sumario executivo com recomendacao de go/no-go."], entregavel: "Relatorio executivo de qualidade com metricas e recomendacao.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Produzi relatorio executivo de qualidade com metricas de cobertura e analise de risco!", proximoProjeto: "Automacao Avancada" },
  // PRODUTO DIGITAL (15)
  { id: "prd-feature-nova", nome: "PRD de Feature Nova", areaSlug: "produto" as string | null, nivel: "Iniciante", objetivo: "Escrever documento de requisitos de produto para uma feature do zero.", ferramentas: ["Notion", "Google Docs"], passosSimplificados: ["Defina o problema que a feature resolve.", "Descreva a solucao proposta e o escopo.", "Liste requisitos funcionais e nao funcionais.", "Adicione criterios de aceite para cada requisito.", "Inclua metricas de sucesso e hipoteses."], entregavel: "PRD completo com problema, solucao, requisitos e metricas.", comoPublicar: "Notion publico ou PDF", sugestaoLinkedIn: "Escrevi meu primeiro PRD completo com problema, solucao e criterios de aceite!", proximoProjeto: "Roadmap Trimestral" },
  { id: "roadmap-produto-trimestral", nome: "Roadmap de Produto Trimestral", areaSlug: "produto" as string | null, nivel: "Iniciante", objetivo: "Criar roadmap visual de produto para um trimestre com temas e entregaveis.", ferramentas: ["Notion", "Miro", "Linear"], passosSimplificados: ["Defina os objetivos estrategicos do trimestre.", "Levante iniciativas e features planejadas.", "Priorize usando framework de impacto e esforco.", "Monte o roadmap visual por mes.", "Compartilhe com stakeholders e colete feedback."], entregavel: "Roadmap trimestral visual com iniciativas priorizadas.", comoPublicar: "Notion publico ou Miro", sugestaoLinkedIn: "Criei roadmap de produto trimestral com prioridades alinhadas aos objetivos!", proximoProjeto: "OKRs de Produto" },
  { id: "okrs-produto", nome: "Framework de OKRs de Produto", areaSlug: "produto" as string | null, nivel: "Iniciante", objetivo: "Definir OKRs para um produto digital alinhados a estrategia da empresa.", ferramentas: ["Notion", "Google Sheets"], passosSimplificados: ["Defina o objetivo estrategico de negocio.", "Crie 3 a 5 Resultados-Chave mensuraveis.", "Defina as iniciativas que movem cada KR.", "Configure o tracker de progresso mensal.", "Documente o processo de revisao quinzenal."], entregavel: "Framework de OKRs com 3 objetivos e 9 KRs com tracker.", comoPublicar: "Notion ou Google Sheets", sugestaoLinkedIn: "Defini OKRs de produto mensuraveis alinhados a estrategia do negocio!", proximoProjeto: "Mapa de Jornada" },
  { id: "mapa-jornada-usuario-produto", nome: "Mapa de Jornada do Usuario", areaSlug: "produto" as string | null, nivel: "Iniciante", objetivo: "Mapear a experiencia completa de um usuario no produto identificando pontos de dor.", ferramentas: ["Miro", "FigJam", "Notion"], passosSimplificados: ["Defina a persona e o objetivo principal.", "Mapeie todas as etapas da interacao com o produto.", "Anote acoes, pensamentos e emocoes.", "Identifique os 3 maiores pontos de dor.", "Proponha melhorias para cada ponto de dor."], entregavel: "Mapa de jornada com 5 etapas, emocoes e oportunidades de melhoria.", comoPublicar: "Miro ou Notion", sugestaoLinkedIn: "Mapeei jornada completa do usuario e identifiquei oportunidades de produto!", proximoProjeto: "Pesquisa de Discovery" },
  { id: "pesquisa-discovery", nome: "Pesquisa de Discovery com Entrevistas", areaSlug: "produto" as string | null, nivel: "Intermediário", objetivo: "Conduzir pesquisa de discovery para validar hipoteses de produto com usuarios reais.", ferramentas: ["Notion", "Zoom", "Miro"], passosSimplificados: ["Defina as hipoteses a validar.", "Crie roteiro de entrevista com 10 perguntas abertas.", "Recrute e entreviste 5 usuarios.", "Organize respostas em mapa de afinidade.", "Extraia insights e invalide ou confirme hipoteses."], entregavel: "Relatorio de discovery com hipoteses validadas e proximas acoes.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Conduzi 5 entrevistas de discovery e validei hipoteses de produto!", proximoProjeto: "Analise de Metricas" },
  { id: "analise-metricas-retencao", nome: "Analise de Metricas de Retencao", areaSlug: "produto" as string | null, nivel: "Intermediário", objetivo: "Analisar metricas de retencao de usuarios e propor acoes de melhoria.", ferramentas: ["Google Analytics", "Amplitude", "Mixpanel", "Excel"], passosSimplificados: ["Acesse dados de retencao D1, D7 e D30.", "Identifique onde os usuarios abandonam o produto.", "Segmente a analise por canal de aquisicao.", "Proponha 3 hipoteses de melhoria.", "Defina experimentos para testar cada hipotese."], entregavel: "Relatorio de retencao com analise de funil e hipoteses de melhoria.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Analisei metricas de retencao e propus hipoteses de melhoria baseadas em dados!", proximoProjeto: "Priorizacao RICE" },
  { id: "priorizacao-rice", nome: "Priorizacao com Framework RICE", areaSlug: "produto" as string | null, nivel: "Intermediário", objetivo: "Priorizar backlog de features usando o framework RICE de forma estruturada.", ferramentas: ["Notion", "Google Sheets"], passosSimplificados: ["Liste todas as features do backlog.", "Estime Reach, Impact, Confidence e Effort.", "Calcule o score RICE para cada item.", "Ordene o backlog pelo score.", "Documente as decisoes de priorizacao."], entregavel: "Backlog priorizado com scores RICE e justificativas documentadas.", comoPublicar: "Notion ou Google Sheets", sugestaoLinkedIn: "Priorizei backlog de produto usando framework RICE de forma estruturada!", proximoProjeto: "Analise de Concorrentes" },
  { id: "analise-concorrentes-produto", nome: "Analise Competitiva de Produto", areaSlug: "produto" as string | null, nivel: "Intermediário", objetivo: "Conduzir analise estruturada de concorrentes para identificar gaps e oportunidades.", ferramentas: ["Notion", "Miro", "Google Sheets"], passosSimplificados: ["Identifique 5 concorrentes diretos e indiretos.", "Defina os criterios de comparacao.", "Analise features, precos e posicionamento.", "Monte matriz de comparacao visual.", "Identifique gaps e oportunidades de diferenciacao."], entregavel: "Matriz competitiva com gaps identificados e oportunidades de produto.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Conduzi analise competitiva estruturada e identifiquei oportunidades de diferenciacao!", proximoProjeto: "Especificacao de Produto" },
  { id: "especificacao-produto", nome: "Documento de Especificacao Tecnica", areaSlug: "produto" as string | null, nivel: "Intermediário", objetivo: "Escrever especificacao tecnica de produto para alinhar times de produto e engenharia.", ferramentas: ["Notion", "Confluence", "Figma"], passosSimplificados: ["Defina o escopo e objetivos da feature.", "Descreva o comportamento esperado em cada cenario.", "Adicione wireframes ou referencias de UI.", "Especifique as regras de negocio.", "Liste dependencias e riscos tecnicos."], entregavel: "Especificacao tecnica completa pronta para desenvolvimento.", comoPublicar: "Notion ou Confluence", sugestaoLinkedIn: "Escrevi especificacao tecnica que alinhou produto e engenharia!", proximoProjeto: "Plano de Lancamento" },
  { id: "plano-lancamento-feature", nome: "Plano de Lancamento de Feature", areaSlug: "produto" as string | null, nivel: "Avançado", objetivo: "Planejar o lancamento de uma feature nova com estrategia de comunicacao e medicao.", ferramentas: ["Notion", "Trello", "Google Analytics"], passosSimplificados: ["Defina a data de lancamento e criterios de go/no-go.", "Planeje a comunicacao para usuarios e stakeholders.", "Configure feature flags para lancamento gradual.", "Defina as metricas de sucesso do lancamento.", "Crie plano de rollback em caso de problemas."], entregavel: "Plano de lancamento com checklist, comunicacao e metricas.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Planejei lancamento de feature com estrategia de rollout gradual e plano de rollback!", proximoProjeto: "Analise de Funil" },
  { id: "analise-funil-conversao", nome: "Analise de Funil de Conversao", areaSlug: "produto" as string | null, nivel: "Avançado", objetivo: "Mapear e otimizar o funil de conversao identificando os maiores pontos de queda.", ferramentas: ["Google Analytics", "Amplitude", "Hotjar", "Excel"], passosSimplificados: ["Mapeie todas as etapas do funil de conversao.", "Extraia as taxas de conversao por etapa.", "Use heatmaps para entender comportamento.", "Identifique a etapa com maior queda.", "Proponha e priorize 3 experimentos de otimizacao."], entregavel: "Relatorio de funil com analise de queda e experimentos propostos.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Analisei funil de conversao e identifiquei os principais pontos de queda!", proximoProjeto: "Teste AB" },
  { id: "hipoteses-teste-ab", nome: "Hipoteses e Design de Teste A/B", areaSlug: "produto" as string | null, nivel: "Avançado", objetivo: "Formular hipoteses e desenhar testes A/B para otimizar metricas de produto.", ferramentas: ["Notion", "Google Optimize", "Excel"], passosSimplificados: ["Defina a metrica a otimizar.", "Formule hipotese no formato Se/Entao/Porque.", "Calcule o tamanho de amostra necessario.", "Desenhe as variantes de controle e tratamento.", "Documente o criterio de sucesso e duracao do teste."], entregavel: "Design de 3 testes A/B com hipoteses e criterios de sucesso.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Desenhei testes A/B com hipoteses estruturadas e calculo de tamanho de amostra!", proximoProjeto: "Personas de Usuario" },
  { id: "personas-usuario", nome: "Personas de Usuario Baseadas em Dados", areaSlug: "produto" as string | null, nivel: "Avançado", objetivo: "Criar personas fundamentadas em pesquisa qualitativa e dados quantitativos.", ferramentas: ["Notion", "Miro", "Google Analytics", "Hotjar"], passosSimplificados: ["Combine dados de analytics com insights de entrevistas.", "Identifique segmentos de usuarios com comportamentos distintos.", "Crie 3 personas com nome, objetivos e dores.", "Valide as personas com stakeholders.", "Use as personas para priorizar decisoes de produto."], entregavel: "3 personas validadas com dados quantitativos e qualitativos.", comoPublicar: "Miro ou Notion", sugestaoLinkedIn: "Criei personas de usuario baseadas em dados quantitativos e entrevistas!", proximoProjeto: "Estrategia de Produto" },
  { id: "estrategia-produto", nome: "Estrategia de Produto de 12 Meses", areaSlug: "produto" as string | null, nivel: "Avançado", objetivo: "Elaborar estrategia de produto para os proximos 12 meses alinhada ao negocio.", ferramentas: ["Notion", "Miro", "Google Slides"], passosSimplificados: ["Defina a visao de longo prazo do produto.", "Analise o mercado e posicionamento competitivo.", "Defina as apostas estrategicas por semestre.", "Crie o roadmap tematico de alto nivel.", "Apresente para stakeholders e colete alinhamento."], entregavel: "Estrategia de produto com visao, apostas e roadmap tematico.", comoPublicar: "Notion ou Google Slides", sugestaoLinkedIn: "Elaborei estrategia de produto para 12 meses com visao e apostas estrategicas!", proximoProjeto: "Retrospectiva de Produto" },
  { id: "retrospectiva-produto", nome: "Retrospectiva e Aprendizados de Produto", areaSlug: "produto" as string | null, nivel: "Avançado", objetivo: "Conduzir retrospectiva de ciclo de produto documentando aprendizados e proximos passos.", ferramentas: ["Notion", "Miro", "FigJam"], passosSimplificados: ["Colete metricas e resultados do ciclo.", "Identifique o que foi bem e o que pode melhorar.", "Conduza sessao colaborativa com o time.", "Documente os principais aprendizados.", "Defina as mudancas de processo para o proximo ciclo."], entregavel: "Documento de retrospectiva com aprendizados e acoes de melhoria.", comoPublicar: "Notion ou PDF", sugestaoLinkedIn: "Conduzi retrospectiva de produto e transformei aprendizados em melhorias de processo!", proximoProjeto: "OKRs do Proximo Ciclo" },
];
