...
describe("numeraisSemLastro: o caso real medido", () => {
  ...
  it("LIMITACAO CONHECIDA: reatribuicao passa, porque o numero existe na origem", () => {
    // O perfil atribui os ~86% aos pre-routers em queries comuns. Aqui o
    // numero foi colado no agente. O 86 esta na origem, entao a verificacao
    // mecanica aprova. Isto e reatribuicao e continua dependendo do prompt e
    // de leitura humana; esta registrado na rubrica, emenda 1.
    expect(
      numeraisSemLastro(
