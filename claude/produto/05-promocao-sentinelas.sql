...
--   4. Conferir as verificacoes do fim (sao quatro) ANTES de dar deploy do
--      frontend.
--
...
--
-- `and is_published = false` em todo UPDATE da secao 1: com a guarda, rodar o
-- arquivo uma segunda vez toca ZERO linhas. Sem ela, a re-execucao mexeria nas
-- 36 de novo e a verificacao 2 (esperado 0 sentinelas nao publicadas) deixaria
-- de distinguir "promovi agora" de "ja estava promovido".
